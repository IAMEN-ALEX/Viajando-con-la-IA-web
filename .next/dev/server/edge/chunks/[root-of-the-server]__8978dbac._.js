...
function middleware(request) {
    ...
    if (request.nextUrl.pathname.match(/\.(css|js|json|png|jpg|ico|svg|webp)$/) || request.nextUrl.pathname.startsWith('/_next') || request.nextUrl.pathname.startsWith('/api/auth') || request.nextUrl.pathname === '/manifest.json') {
