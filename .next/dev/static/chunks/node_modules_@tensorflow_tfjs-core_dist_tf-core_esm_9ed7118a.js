...
function g(t, e) {
    if (void 0 === e && (e = []), null == e && (e = []), Array.isArray(t) || F(t)) for(var n = 0; n < t.length; ++n)g(t[n], e);
    else e.push(t);
    return e;
}
function y(t) {
...
var Q = Object.freeze({
    ...
    return t.prototype.logKernelProfile = function(t, e, n, r, o) {
        var a = E(r + "ms", 9), i = E(t, 25), s = e.rank, u = e.size, l = E(e.shape.toString(), 14);
        console.log("%c" + i + "\t%c" + a + "\t%c" + s + "D " + l + "\t%c" + u + "\t%c" + o, "font-weight:bold", "color:red", "color:blue", "color: orange", "color: green");
    }, t;
}(), tt = 20, et = 3, nt = 7;
function rt(t, e, n, r) {
    var o = G(e), a = function(t, e, n, r) {
        var o = y(e), a = r[r.length - 1], i = new Array(a).fill(0), s = e.length, u = "complex64" === n ? it(t) : t;
        ...
        if (1 === l) {
            if (u > tt) {
                var h = et * s, p = Array.from(e.slice(0, h)), f = Array.from(e.slice(u - et * s, u));
                return "complex64" === r && (p = it(p), f = it(f)), [
                    "[" + p.map(function(t, e) {
                        return ot(t, a[e], r);
...
var ht = function() {
    ...
    return t.make = function(e, n, r, o) {
            ...
            return o(this, function(e) {
                switch(e.label){
                    ...
                    case 1:
                        return t = e.sent(), [
                            2,
                            lt.buffer(this.shape, this.dtype, t)
                        ];
                }
            });
        });
        ...
        return void 0 === r && (r = "NHWC"), void 0 === o && (o = [
            1,
            1
        ]), this.throwIfDisposed(), lt.conv2d(this, t, e, n, r, o, a);
        ...
        return void 0 === r && (r = "NHWC"), void 0 === o && (o = [
            1,
            1
        ]), this.throwIfDisposed(), lt.depthwiseConv2d(this, t, e, n, r, o, a);
    }, t.prototype.separableConv2d = function(t, e, n, r, o, a) {
        return void 0 === o && (o = [
            1,
            1
        ]), void 0 === a && (a = "NHWC"), this.throwIfDisposed(), lt.separableConv2d(this, t, e, n, r, o, a);
...
var ft, dt, vt, mt, gt, yt = pt.variable;
!function(t) {
...
var It, St = Object.freeze({
    ...
    return t.prototype.ready = function() {
            ...
            return o(this, function(o) {
                switch(o.label){
                    ...
                    case 3:
                        ...
                        o.label = 4;
                    case 4:
                        return this.backendInstance = this.registry[t], this.profiler = new J(this.backendInstance), [
                            2,
                            !0
                        ];
                }
        ...
        var e = this, n = At.registryFactory[t];
        ...
        var r, o = this, a = [], i = this.isTapeOn(), s = null != this.state.activeScope ? this.state.activeScope.name : "", u = function(t) {
            i && (a = t.map(function(t) {
                return o.keep(o.clone(t));
            }));
        }, l = this.state.numBytes, c = this.state.numTensors;
        ...
        return this.tidy("backward", function() {
            ...
            s[a.id] = null == n ? (t = a.shape, r = $(y(t), "float32"), ht.make(t, {
                ...
                for(var r = function(r) {
                    ...
                    var i = o.gradient(1 === o.outputs.length ? a[0] : a), s = function(e) {
        ...
        return d(z(t), function() {
            ...
            return r.forEach(function(t, e) {
                ...
                return d((n = t.apply(void 0, r.concat([
                    o
                ]))).value instanceof ht, function() {
        ...
        var r = this.state.tensorInfo.get(e), o = r.backend;
...
function Vt(t, e, n) {
    ...
    if (Mt(t, e, function() {
        ...
        var l = i.slice(0, r - 1), c = i.slice(r - 1, r), h = i.slice(r);
...
function Ye(t, e, n, r) {
    ...
    if ("string" !== o && [
        ...
        "int32",
        "float32"
    ].indexOf(r) >= 0 && (o = r), Xe(r, o, e, n), null == t || !F(t) && !Array.isArray(t) && "number" != typeof t && "boolean" != typeof t && "string" != typeof t) {
        var a = null == t ? "null" : t.constructor.name;
        throw new Error("Argument '" + e + "' passed to '" + n + "' must be a Tensor or TensorLike, but got '" + a + "'");
    }
    var i = Ke(t);
    F(t) || Array.isArray(t) || (t = [
        t
    ]);
...
var cn = ln({
    complex_: function(t, e) {
        var n = Ye(t, "real", "complex"), r = Ye(e, "imag", "complex");
...
function dn(t, e, n, r) {
    ...
    if (null != e) {
        ...
        for(var i = 0; i < n.length; ++i){
            var u = n[i], l = i !== n.length - 1 || u !== y(e.slice(i));
            d(n[i] === e[i] || !l, function() {
                return "Error creating a new Tensor. Inferred shape (" + n + ") does not match the provided shape (" + e + "). ";
            });
        }
    }
    return F(t) || Array.isArray(t) || (t = [
        t
    ]), e = e || n, t = "string" !== r ? q(t, r, s.getBool("DEBUG")) : g(t), ht.make(e, {
        values: t
    }, r);
}
function vn(t, e) {
...
function Cn(t, e) {
    if (void 0 === e && (e = "float32"), "complex64" === e) {
        var n = Cn(t, "float32"), r = En(t, "float32");
        return cn(n, r);
    }
    var o = $(y(t), e);
    return ht.make(t, {
...
function En(t, e) {
    if (void 0 === e && (e = "float32"), "complex64" === e) {
        var n = En(t, "float32"), r = En(t, "float32");
        return cn(n, r);
    }
    var o = j(y(t), e);
    return ht.make(t, {
...
function Sn(t, e, n, r) {
    ...
    if (t === e || t < e && n < 0 || e < t && n > 1) return En([
        0
    ], r);
...
var Bn = Mn(function(t) {
    ...
    !function(e, n) {
        var r, o = this, a = 256, i = 6, s = "random", u = n.pow(a, i), l = n.pow(2, 52), c = 2 * l, h = a - 1;
        function p(t, h, p) {
        ...
        if (n["seed" + s] = p, v(n.random(), e), t.exports) {
            t.exports = p;
            try {
                r = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/crypto-browserify/index.js [app-client] (ecmascript)");
            } catch (t) {}
        }
    }([], Math);
});
Vn.alea = Bn, Vn.xor128 = Pn, Vn.xorwow = Ln, Vn.xorshift7 = Wn, Vn.xor4096 = Un, Vn.tychei = zn;
var Gn = Vn.alea, qn = function() {
    function t(t, e, n, r, o) {
...
var Kn = ln({
    batchToSpaceND_: function(t, e, n) {
        var r = Ye(t, "x", "batchToSpaceND"), o = e.reduce(function(t, e) {
            return t * e;
        });
    ...
    cumsum_: function(t, e, n, r) {
        ...
        var o = Ye(t, "x", "cumsum"), a = rn([
            e |= 0
        ], o.rank), i = o;
        null != a && (i = o.transpose(a));
        var s = an(1, o.rank)[0], u = At.runKernel(function(t) {
    ...
    depthToSpace_: function(t, e, n) {
        void 0 === n && (n = "NHWC");
        var r = Ye(t, "x", "depthToSpace"), o = "NHWC" === n ? r.shape[1] : r.shape[2], a = "NHWC" === n ? r.shape[2] : r.shape[3], i = "NHWC" === n ? r.shape[3] : r.shape[1];
    ...
    eye_: function(t, e, n, r) {
        ...
        if (null == n) return s;
        if (1 === n.length) return vr(Zn(s, 0), [
            n[0],
            1,
            1
        ]);
        if (2 === n.length) return vr(Zn(Zn(s, 0), 0), [
            n[0],
            n[1],
            1,
            1
        ]);
        if (3 === n.length) return vr(Zn(Zn(Zn(s, 0), 0), 0), [
            n[0],
            n[1],
            n[2],
            1,
    ...
    multinomial_: function(t, e, n, r) {
        void 0 === r && (r = !1);
        var o = Ye(t, "logits", "multinomial"), a = o.size, i = o.rank;
        ...
        n = n || Math.random();
        var s = 1 === i ? o.as2D(1, -1) : o, u = At.runKernel(function(t) {
    ...
    oneHot_: function(t, e, n, r) {
        ...
        var o = Ye(t, "indices", "oneHot", "int32"), a = o.shape.concat([
            e
        ]);
            ...
            switch(o.label){
                ...
                case 2:
                    ...
                    for(l = new st([
                        ...
                        u
                    ], "int32"), h = 0, p = 0; h < a.length; h++)s.has(a[h]) || (l.values[p] = a[h], c.values[p] = h, p++);
                    return [
                        2,
                        [
                            l.toTensor(),
...
function Fr(t) {
    return d(z(t), function() {
        ...
        var r = Ye(e, "x", "tf.grad", null), o = null != n ? Ye(n, "dy", "tf.grad") : null;
...
function Mr(t) {
    return d(z(t), function() {
        ...
        var r = Qe(e, "args", "tf.grads", null), o = null != n ? Ye(n, "dy", "tf.grads") : null;
        return At.tidy(function() {
            var e = At.gradients(function() {
...
function Lr(t, e) {
    ...
    var i = At.gradients(t, e, null, !0), s = i.value, u = i.grads;
    d(u.some(function(t) {
        return null != t;
    }), function() {
...
function Xr(t, e, n, r, o, a, i, s) {
    ...
    var u = [
        ...
        -1,
        -1
    ], l = u[0], c = u[1], h = u[2], p = u[3];
    if ("channelsLast" === s) l = t[0], c = t[1], h = t[2], p = t[3];
    else {
        if ("channelsFirst" !== s) throw new Error("Unknown dataFormat " + s);
        l = t[0], p = t[1], c = t[2], h = t[3];
    }
    var f, v = e[0], m = e[1], g = e[3], y = Jr(n), x = y[0], w = y[1], C = Jr(r), E = C[0], R = C[1], I = to(v, E), S = to(m, R), N = function(t, e, n, r, o, a, i, s) {
        var u, l, c;
        if ("number" == typeof t) {
            ...
            var p = function(t, e, n, r, o, a) {
                null == o && (o = Qr(t, e, r));
                var i = t[0], s = t[1], u = eo((i - e + 2 * o) / r + 1, a);
                d(b(u), function() {
            ...
            var f = Math.max(0, (l - 1) * r + a - e), v = Math.max(0, (c - 1) * o + i - n), m = Math.floor(f / 2), g = f - m, y = Math.floor(v / 2), x = v - y;
            u = {
                top: m,
                bottom: g,
                left: y,
    ...
    }(o, c, h, x, w, I, S, a), k = N.padInfo, A = N.outHeight, T = N.outWidth, D = i ? g * p : g;
...
function Yr(t, e, n, r, o, a, i) {
    ...
    var s = [
        ...
        -1,
        -1
    ], u = s[0], l = s[1], c = s[2], h = s[3], p = s[4];
    if ("channelsLast" === i) u = t[0], l = t[1], c = t[2], h = t[3], p = t[4];
    else {
        if ("channelsFirst" !== i) throw new Error("Unknown dataFormat " + i);
        u = t[0], p = t[1], l = t[2], c = t[3], h = t[4];
    }
    var f, d = e[0], v = e[1], m = e[2], g = e[4], y = Zr(n), x = y[0], b = y[1], w = y[2], C = Zr(r), E = C[0], R = C[1], I = C[2], S = function(t, e, n, r, o, a, i, s, u, l) {
        var c, h, p, f;
        if ("same" === t) {
            h = Math.ceil(e / o), p = Math.ceil(n / a), f = Math.ceil(r / i);
            var d = (h - 1) * o + s - e, v = (p - 1) * a + u - n, m = (f - 1) * i + l - r, g = Math.floor(d / 2), y = d - g, x = Math.floor(v / 2), b = v - x, w = Math.floor(m / 2), C = m - w;
            c = {
                top: x,
                bottom: b,
                left: w,
    ...
    }(o, l, c, h, x, b, w, to(d, E), to(v, R), to(m, I)), N = S.padInfo, k = S.outDepth, A = S.outHeight, T = S.outWidth, D = a ? g * p : g;
    return "channelsFirst" === i ? f = [
        u,
        D,
        k,
        A,
...
function oo(t, e, n) {
    if ("complex64" === e) {
        ...
        var r = En(t.shape), o = t.toFloat(), a = n.complex(o, r);
...
function fo(t, e, n) {
    var r = t.subarray(4 * e, 4 * e + 4), o = t.subarray(4 * n, 4 * n + 4), a = Math.min(r[0], r[2]), i = Math.min(r[1], r[3]), s = Math.max(r[0], r[2]), u = Math.max(r[1], r[3]), l = Math.min(o[0], o[2]), c = Math.min(o[1], o[3]), h = Math.max(o[0], o[2]), p = Math.max(o[1], o[3]), f = (s - a) * (u - i), d = (h - l) * (p - c);
    if (f <= 0 || d <= 0) return 0;
    var v = Math.max(a, l), m = Math.max(i, c), g = Math.min(s, h), y = Math.min(u, p), x = Math.max(g - v, 0) * Math.max(y - m, 0);
    return x / (f + d - x);
}
function vo(t, e, n) {
...
function go(t, e, n, r, o) {
    for(var a = e[e.length - 1], i = [
        t.length / a,
        a
    ], s = i[0], u = i[1], l = k(n, s * r), c = k("int32", s * r), h = 0; h < s; h++){
        ...
        var m = h * r, g = l.subarray(m, m + r), y = c.subarray(m, m + r);
...
function ko(t, e, n, r) {
    ...
    var a, i, s = o.join("\n"), u = t.map(function(t) {
        return function(t, e, n) {
            ...
            o.length <= a.length && (r += n ? function(t, e) {
                var n, r = t.name, o = r.charAt(0).toUpperCase() + r.slice(1), a = "get" + o + "AtOutCoords", i = t.shapeInfo.logicalShape.length, s = e.logicalShape.length, u = Hr(t.shapeInfo.logicalShape, e.logicalShape), l = Po(s), c = s - i, h = [
                    "x",
                    "y",
                    "z",
                    "w",
                ...
                var f = "return outputValue;", d = 1 === y(t.shapeInfo.logicalShape), v = 1 === y(e.logicalShape);
                if (1 !== i || d || v) {
                ...
                var l, c = Po(u), h = Hr(t.shapeInfo.logicalShape, e.logicalShape), p = u - s, f = [
                    "x",
                    "y",
                    "z",
                    "w",
    ...
    }).join("\n"), l = e.texShape, c = Ro(), h = function(t) {
    ...
    switch(e.length){
        case 0:
            return function(t) {
                ...
                var i = t.shapeInfo.texShape, s = i[0], u = i[1], l = Mo(e);
        ...
        case 2:
            return function(t) {
                ...
                var s = N(e), u = s.newShape, l = s.keptDims, c = u;
        ...
        case 3:
            return function(t) {
                var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = e[1] * e[2], a = e[2], i = N(e), s = i.newShape, u = i.keptDims, l = s;
                ...
                var h = t.shapeInfo.texShape, p = h[0], f = h[1], d = t.shapeInfo.flatOffset;
        ...
        case 4:
            return function(t) {
                var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = e[3], a = e[2] * o, i = e[1] * a, s = N(e), u = s.newShape, l = s.keptDims;
        ...
        case 5:
            return function(t) {
                var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = e[4], a = e[3] * o, i = e[2] * a, s = e[1] * i, u = N(e), l = u.newShape, c = u.keptDims;
                if (l.length < e.length) {
                    var h = Lo(t, l);
        ...
        case 6:
            return function(t) {
                var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = N(e), a = o.newShape, i = o.keptDims;
                ...
                var u = e[5], l = e[4] * u, c = e[3] * l, h = e[2] * c, p = e[1] * h;
                if (t.shapeInfo.isUniform) return "\n      float " + r + "(int row, int col, int depth,\n                  int depth2, int depth3, int depth4) {\n        int index = round(dot(\n          vec4(row, col, depth, depth2),\n          vec4(" + p + ", " + h + ", " + c + ", " + l + ")) +\n          dot(\n            vec2(depth3, depth4),\n            vec2(" + u + ", 1)));\n        " + Bo(t) + "\n      }\n    ";
                var f = t.shapeInfo.flatOffset, d = t.shapeInfo.texShape, v = d[0], m = d[1];
...
function To(t) {
    ...
    switch(t.shapeInfo.logicalShape.length){
        ...
        case 2:
            return function(t) {
                var e = t.shapeInfo.logicalShape, n = t.name, r = "get" + n.charAt(0).toUpperCase() + n.slice(1), o = t.shapeInfo.texShape, a = o[0], i = o[1], s = Ro();
        ...
        case 3:
            return function(t) {
                ...
                var u = a[0], l = a[1], c = Math.ceil(e[2] / 2), h = c * Math.ceil(e[1] / 2), p = Ro();
        ...
        default:
            return function(t) {
                for(var e = t.shapeInfo.logicalShape, n = e.length, r = t.name, o = "get" + r.charAt(0).toUpperCase() + r.slice(1), a = t.shapeInfo.texShape, i = [
                    Math.ceil(a[0] / 2),
                    Math.ceil(a[1] / 2)
                ], s = i[0], u = i[1], l = Math.ceil(e[n - 1] / 2), c = l * Math.ceil(e[n - 2] / 2), h = "int b, int row, int col", p = "b * " + c + " + (row / 2) * " + l + " + (col / 2)", f = 2; f < n - 1; f++)h = "int b" + f + ", " + h, c *= e[n - f - 1], p = "b" + f + " * " + c + " + " + p;
                var d = Ro();
...
function Bo(t) {
    var e = t.name, n = y(t.shapeInfo.logicalShape);
    return n < 2 ? "return " + e + ";" : "\n    for (int i = 0; i < " + n + "; i++) {\n      if (i == index) {\n        return " + e + "[i];\n      }\n    }\n  ";
}
function Po(t) {
    if (t <= 1) return "int";
...
var Uo = function() {
    return function(t, e, n, r) {
        this.variableNames = [
            "A"
        ], this.usesPackedTextures = !0, d(t.length > 2, function() {
        ...
        var i, s, u = this.outputShape, l = u.length, c = Po(l), h = Eo("coords", l);
        if (1 === a) {
            var p = Po(s = l + 1);
        ...
        var f = [
            ...
            "u",
            "v"
        ].slice(0, s), v = "." + f[s - 1], m = f.map(function(t) {
            return "int " + t;
        }), g = Eo("sourceLocR", s - 1).concat("inIdx.r"), y = Eo("sourceLocG", s - 1).concat("inIdx.g"), x = Eo("sourceLocB", s - 1).concat("inIdx.b"), b = Eo("sourceLocA", s - 1).concat("inIdx.a"), w = "max" === n ? "greaterThan" : "lessThan", C = r ? "" : "\n          inIdx = round(vec4(getBestIndicesAChannel(" + g.join() + "),\n                             getBestIndicesAChannel(" + y.join() + "),\n                             getBestIndicesAChannel(" + x.join() + "),\n                             getBestIndicesAChannel(" + b.join() + ")));", E = "vec4(\n            getAChannel(" + g.join() + "),\n            hasNextCol ? getAChannel(" + y.join() + ") : 0.,\n            hasNextRow ? getAChannel(" + x.join() + ") : 0.,\n            hasNextRow && hasNextCol ? getAChannel(" + b.join() + ") : 0.)", R = r ? "" : "\n      float getBestIndicesAChannel(" + m.join() + ") {\n        return getChannel(getBestIndicesA(" + f.join() + "),\n                                          vec2(" + f.slice(-2).join() + "));\n      }";
    ...
    return function(t) {
        ...
        var e = t.filterHeight, n = t.filterWidth, r = t.strideHeight, o = t.strideWidth, a = t.dilationHeight, i = t.dilationWidth, s = t.effectiveFilterHeight, u = t.effectiveFilterWidth, l = s - 1 - t.padInfo.top, c = u - 1 - t.padInfo.left, h = 1 / (e * n);
...
}(), qo = "return areal * breal - aimag * bimag;", Ho = "return areal * bimag + aimag * breal;", $o = function() {
    return function(t, e, n) {
        this.variableNames = [
            "AReal",
            "AImag",
            "BReal",
            "BImag"
        ], this.outputShape = jr(e, n), this.userCode = "\n      float binaryOpComplex(\n          float areal, float aimag, float breal, float bimag) {\n        " + t + "\n      }\n\n      void main() {\n        float areal = getARealAtOutCoords();\n        float aimag = getAImagAtOutCoords();\n        float breal = getBRealAtOutCoords();\n        float bimag = getBImagAtOutCoords();\n        setOutput(binaryOpComplex(areal, aimag, breal, bimag));\n      }\n    ";
    };
}(), jo = "return a + b;", Ko = "return a - b;", Xo = "return a * b;", Yo = function() {
    return function(t, e, n) {
        this.variableNames = [
            "A",
            "B"
    ...
    return function(t, e, n, r) {
        void 0 === r && (r = !1), this.variableNames = [
            "A",
            "B"
        ], this.supportsBroadcasting = !0, this.usesPackedTextures = !0, this.outputShape = jr(e, n);
    ...
    function t(t) {
        this.variableNames = [
            "A"
        ], this.usesPackedTextures = !0, this.outputShape = t, this.userCode = "\n      uniform float min;\n      uniform float max;\n\n      void main() {\n        vec4 value = getAAtOutCoords();\n\n        if (any(isnan(value))) {\n          setOutput(value);\n          return;\n        }\n\n        setOutput(clamp(value, vec4(min), vec4(max)));\n      }\n    ";
    }
    return t.prototype.getCustomSetupFunc = function(t, e) {
        var n = this;
        return function(r, o) {
    ...
    return function(t, e) {
        ...
        var n = this.outputShape, r = n.length, o = Po(r), a = Eo("coords", r), i = [
            "x",
            "y",
            "z",
            "w",
        ...
        var l = i[e], c = "vec2(" + i.slice(-2).join() + ")", h = i.join(), p = "if (" + l + " < " + s[0] + ")\n          return getChannel(getT0(" + h + "), " + c + ");";
    ...
    return function(t) {
        ...
        var e = t.filterHeight, n = t.filterWidth, r = t.strideHeight, o = t.strideWidth, a = e - 1 - t.padInfo.top, i = n - 1 - t.padInfo.left;
    ...
    return function(t) {
        ...
        var e = t.filterDepth, n = t.filterHeight, r = t.filterWidth, o = t.strideDepth, a = t.strideHeight, i = t.strideWidth, s = e - 1 - t.padInfo.front, u = n - 1 - t.padInfo.top, l = r - 1 - t.padInfo.left;
    ...
    return function(t) {
        ...
        var e = t.padInfo.top, n = t.padInfo.left, r = t.strideHeight, o = t.strideWidth, a = t.dilationHeight, i = t.dilationWidth, s = t.filterHeight, u = t.filterWidth, l = 4 * Math.floor(t.inChannels / 4), c = t.inChannels % 4;
    ...
    return function(t) {
        ...
        var e = t.padInfo.front, n = t.padInfo.top, r = t.padInfo.left, o = t.strideDepth, a = t.strideHeight, i = t.strideWidth, s = t.dilationDepth, u = t.dilationHeight, l = t.dilationWidth, c = t.filterDepth, h = t.filterHeight, p = t.filterWidth, f = 4 * Math.floor(t.inChannels / 4), d = t.inChannels % 4;
    ...
    return function(t) {
        ...
        var e = t.inHeight, n = t.inWidth, r = t.padInfo.top, o = t.padInfo.left, a = t.strideHeight, i = t.strideWidth, s = t.dilationHeight, u = t.dilationWidth, l = t.filterHeight, c = t.filterWidth, h = t.outChannels / t.inChannels;
    ...
    return function(t) {
        this.variableNames = [
            "x",
            "W"
        ], this.usesPackedTextures = !0, this.outputShape = t.outShape;
    ...
    return function(t, e, n, r, o) {
        ...
        var a = t[0], i = t[1], s = t[2], u = t[3], l = e[0], c = n[0], h = n[1];
        this.outputShape = [
            l,
            c,
            h,
...
var ma = function() {
...
}(), Ea = "return real * expR - imag * expI;", Ra = "return real * expI + imag * expR;", Ia = function() {
    return function(t, e, n) {
        this.variableNames = [
            "real",
            "imag"
    ...
    return function(t, e, n) {
        ...
        var o = Po(this.rank), a = function(t, e) {
            var n = t.length;
...
var Ta, Da, _a = function() {
    return function(t, e, n) {
        ...
        var r = Po(e.length), o = Po(n.length), a = this.sliceDim > 1 ? "strides[j]" : "strides";
...
function Pa(t, e) {
    return Xt(t, e, new Float32Array([
        -1,
        1,
        0,
        0,
...
function Qa(t, e, n, r, o) {
    var a = Oa(n, r), i = a[0], s = a[1], u = new Uint8Array(n * r * 4);
    return Mt(t, e, function() {
...
function Ja(t, e, n, r, o, a, i, s) {
    var u = t, l = new Float32Array(function(t, e) {
        var n = Ma(t, e);
        return n[0] * n[1] * 4;
    }(a, i));
...
var ti = Object.freeze({
    ...
    return Object.defineProperty(t.prototype, "debug", {
        ...
        var e = this.gl, n = Vt(e, this.debug, t), r = Ba(e, this.debug), o = $t(e, this.debug);
            ...
            return o(this, function(n) {
                switch(n.label){
                    ...
                    case 1:
                        return n.sent(), [
                            2,
                            this.getQueryTime(t, s.getNumber("WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION"))
                        ];
                }
            });
        });
...
var ri = function() {
    return function(t, e, n) {
        this.variableNames = [
            "A"
        ], this.usesPackedTextures = !0, this.outputShape = t;
        var r = n.filterWidth, o = n.inChannels, a = n.strideWidth, i = n.strideHeight, s = n.padInfo, u = n.outWidth, l = n.dilationWidth, c = n.dilationHeight, h = s.left, p = s.top, f = o * r, d = Ro();
    ...
    return function(t, e, n, r, o) {
        this.variableNames = [
            "x"
        ], this.outputShape = [], this.usesPackedTextures = !0;
        var a, i = e, s = t[3] - 1;
        this.outputShape = t;
        var u = "float(" + n + ") + float(" + r + ") * sum";
    ...
    return function(t, e, n, r, o, a) {
        ...
        var i = n ? t[1] : t[2], s = Math.ceil(i / 2), u = n ? "i * 2, rc.y" : "rc.y, i * 2", l = r ? "rc.z, i * 2" : "i * 2, rc.z", c = n ? [
            "a.xxyy",
            "a.zzww"
        ] : [
            "a.xxzz",
    ...
    return function(t) {
        ...
        if (0 === e) this.userCode = "\n        void main() {\n          setOutput(vec4(getA(), 0., 0., 0.));\n        }\n      ";
            ...
            var n = Eo("rc", e), r = Po(e), o = function(t, e, n) {
...
var pi = function() {
    return function(t, e, n) {
        ...
        var r = t.length, o = Po(r), a = e.map(function(t) {
            return t[0];
    ...
    return function(t, e, n) {
        this.variableNames = [
            "x"
        ], this.usesPackedTextures = !0, this.outputShape = e.map(function(e, n) {
            return e[0] + t[n] + e[1];
        });
        for(var r = t.length, o = Po(r), a = e.map(function(t) {
            ...
            return e[0] + t[n];
        }).join(","), s = Eo("rc", r), u = Eo("source", r), l = s[r - 1] + " < " + this.outputShape[r - 1], c = 1 === r ? "source" : "vec2(" + u.slice(-2).join() + ")", h = [
            o + " rc = outputLoc;",
            s[r - 1] + " += 1;\n       if(" + l + ") {\n      ",
    ...
    return function(t, e, n) {
        ...
        var r = t.filterWidth, o = t.strideHeight, a = t.strideWidth, i = t.dilationHeight, s = t.dilationWidth, u = t.effectiveFilterHeight, l = t.effectiveFilterWidth, c = t.padInfo.top, h = t.padInfo.left;
        this.outputShape = t.outShape;
        var p = "avg" === e, f = "0.0";
    ...
    return function(t, e) {
        ...
        var l = 4 * Math.floor(n / 4), c = n % 4, h = "\n      if (" + ("sum" === e) + ") {\n        sumValue += dot(values, ones);\n      } else if (" + ("prod" === e) + ") {\n        vec2 tmp = vec2(values[0], values[1]) * vec2(values[2], values[3]);\n        prodValue *= tmp[0] * tmp[1];\n      } else {\n        minMaxValue = " + s + "(values, minMaxValue);\n      }\n    ", p = "vec4";
...
var gi = function() {
    return function(t, e, n) {
        ...
        var r = e.shape, o = r[1], a = r[2], i = t.shape, s = i[1], u = i[2], l = [
            n && s > 1 ? o - 1 : o,
            n && u > 1 ? a - 1 : a
        ], c = [
            n && s > 1 ? s - 1 : s,
            n && u > 1 ? u - 1 : u
        ], h = l[0] / c[0], p = l[1] / c[1], f = 1 / h, d = 1 / p, v = 2 * Math.ceil(f) + 2, m = 2 * Math.ceil(d) + 2;
    ...
    return function(t, e, n, r) {
        this.variableNames = [
            "A"
        ], this.usesPackedTextures = !0, this.outputShape = [];
        var o = t[0], a = t[1], i = t[2], s = t[3];
        this.outputShape = [
            o,
            e,
    ...
    return function(t, e) {
        ...
        if (n > 4) throw new Error("WebGL backend: Reverse of rank-" + n + " tensor is not yet supported");
        this.outputShape = t;
        var r = Eo("rc", n), o = r[n - 1] + " + 1 < " + this.outputShape[n - 1], a = r[n - 2] + " + 1 < " + this.outputShape[n - 2], i = Po(n);
        function s(n) {
    ...
    return function(t, e, n, r, o, a, i) {
        ...
        var s = Po(o.length), u = Po(a.length), l = "";
        1 === n ? l = "i" : 2 === n && (l = "i, j");
        var c = "getIndices(" + l + ")", h = "";
        1 === r ? h = "i" : 2 === r && (h = "i, coords[1]");
        var p = "getUpdates(" + h + ")", f = e > 1 ? "strides[j]" : "strides";
    ...
    function t(t) {
        ...
        var e, n = Po(this.rank), r = "uniform int start[" + this.rank + "];", o = function(t) {
...
var Ai = function() {
    function t(t) {
        this.variableNames = [
            "source"
        ], this.usesPackedTextures = !0, this.outputShape = t, this.rank = t.length;
        var e = Po(this.rank), n = Eo("coords", this.rank), r = Eo("sourceLoc", this.rank), o = 1 === this.rank ? "sourceLoc" : "vec2(" + r.slice(-2).join() + ")", a = "getChannel(getSource(" + r.join() + "), " + o + ")", i = "\n      result.x = " + a + ";\n      if (++" + n[this.rank - 1] + " < " + t[this.rank - 1] + ") {\n        ++" + r[this.rank - 1] + ";\n        result.y = " + a + ";\n        --" + r[this.rank - 1] + ";\n      }\n    ", s = 1 === this.rank ? "" : "\n      --" + n[this.rank - 1] + ";\n      if (++" + n[this.rank - 2] + " < " + t[this.rank - 2] + ") {\n        ++" + r[this.rank - 2] + ";\n        result.z = " + a + ";\n        if (++" + n[this.rank - 1] + " < " + t[this.rank - 1] + ") {\n          ++" + r[this.rank - 1] + ";\n          result.w = " + a + ";\n        }\n      }\n    ", u = this.rank <= 4 ? "sourceLoc = coords +\n            " + e + "(" + t.map(function(t, e) {
            return "start[" + e + "]";
    ...
    return function(t, e, n, r) {
        ...
        this.outputShape = o;
        var a = n.length, i = Po(n.length), s = Po(o.length), u = "";
...
var Fi = function() {
    return function(t, e) {
        ...
        var o = Po(this.rank), a = function(t) {
            var e = t.length;
...
var Bi = function() {
    return function(t, e) {
        ...
        var o = Po(this.rank), a = Co("rc", this.rank), i = new Array(this.rank);
...
}(), Pi = 1.7580993408473768, Li = 1.0507009873554805, Wi = function() {
    return function(t, e) {
        this.variableNames = [
            "A"
...
var qi = "return exp(x);", Hi = Ui + "\n  return sin(x);\n", $i = Ui + "\n  return cos(x);\n", ji = Ui + "\n  return atan(x);\n", Ki = Ui + "\n  if (x < 1.0) return NAN;\n  return log(x + sqrt(x * x - 1.0));", Xi = Ui + "\n  if ((x < -1.0) || (x > 1.0)) return NAN;\n  return (log(1.0 + x) - log(1.0 - x)) / 2.0;", Yi = "return x;", Qi = "\n  vec4 result = x * vec4(greaterThanEqual(x, vec4(0.0)));\n  bvec4 isNaN = isnan(x);\n\n  result.r = isNaN.r ? x.r : result.r;\n  result.g = isNaN.g ? x.g : result.g;\n  result.b = isNaN.b ? x.b : result.b;\n  result.a = isNaN.a ? x.a : result.a;\n\n  return result;\n", Ji = function() {
    ...
    return function(t) {
        ...
        var e = t.length, n = Eo("rc", e), r = Po(e), o = function(t, e) {
            if (1 === t) return "rc";
...
var ns = function() {
    ...
    return t.prototype.register = function(t, e, n) {
        ...
        var o, a, i = this.makeTensorHandle(n, "int32");
        if (this.texData.get(i.dataId).usage = Ta.PIXELS, this.gpgpu.uploadPixelDataToTexture(this.getTexture(i.dataId), t), s.getBool("WEBGL_PACK")) {
            ...
            a = this.compileAndRun(o, [
                i
            ], u);
        } else o = new Na(r), a = this.compileAndRun(o, [
            i
        ]);
        ...
        var e = this.texData.get(t), n = e.values, r = e.dtype, o = e.complexTensors, a = e.slice, i = e.shape;
        if (null != a) {
            var s = new Wi(i, "return x;"), u = this.compileAndRun(s, [
                {
                    dataId: t,
                    shape: i,
                    dtype: r
        ...
        var c, h, p = null != this.activeTimers;
        ...
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(o) {
                switch(o.label){
                    case 0:
                        if (this.pendingRead.has(t)) return n = this.pendingRead.get(t), [
                            2,
                        ...
                        ]), f = this.read(p.dataId), p.dispose(), [
                            2,
                            f
                        ];
                        if (null != a) return [
                        ...
                        return d = null, "complex64" !== l && s.get("WEBGL_BUFFER_SUPPORTED") && (v = this.decode(t), t = v.dataId, m = this.texData.get(v.dataId), d = (e = this.gpgpu).createBufferFromTexture.apply(e, [
                            m.texture
                        ].concat(Fa(i)))), this.pendingRead.set(t, []), "complex64" === l ? [
                            3,
                            2
                        ] : [
                            4,
                    ...
                    case 3:
                        return x = o.sent(), b = x[0], w = x[1], g = uo(b, w), [
                            3,
                            5
                        ];
                    case 4:
        ...
        var e, n = this, r = this.texData.get(t), o = r.shape, a = r.dtype, i = r.isPacked, u = y(o);
        if (s.getBool("WEBGL_DOWNLOAD_FLOAT_ENABLED")) {
            var l = this.decode(t), c = this.texData.get(l.dataId), h = (e = this.gpgpu).downloadMatrixFromPackedTexture.apply(e, [
                c.texture
            ].concat(Fa(o))).subarray(0, u);
            return this.disposeData(l.dataId), h;
        }
        var p = s.getBool("WEBGL_PACK") && !0 === i, f = p ? fe(o) : o, d = this.makeTensorHandle(f, "float32");
        ...
        }), m = this.texData.get(v.dataId), g = this.gpgpu.downloadByteEncodedFloatMatrixFromOutputTexture(m.texture, m.texShape[0], m.texShape[1]).subarray(0, u);
        ...
        var e = this.texData.get(t), n = e.texture, r = e.dtype, o = e.texShape, a = e.usage, i = e.isPacked, s = e.slice, u = s && s.origDataId || t, l = this.dataRefCount.get(u);
        ...
        var r = this.texData.get(t.dataId).isPacked, o = _r(t.shape, e, n);
        if (r || !o) {
            var a = s.getBool("WEBGL_PACK_ARRAY_OPERATIONS") ? new Ai(n) : new Ni(n), i = a.getCustomSetupFunc(e);
        ...
        var r = this.texData.get(t.dataId), o = ht.make(n, {}, t.dtype, this), a = this.texData.get(o.dataId);
        ...
        if (this.shouldExecuteOnCPU([
            t
        ])) return this.cpuBackend.stridedSlice(t, e, n, r, o, a, i, s, u);
        var l = Ar(t.shape, e, n, r, o, a, i, s, u), c = l[0], h = l[1], p = l[2], f = h.filter(function(t, e) {
        ...
        if ((1 === o || 1 === a) && i > 1e3) {
            ...
            var u = 1 === a ? t : t.as3D(s, i, 1), l = 1 === a ? 2 : 1, c = 1 === a ? e.as3D(s, 1, i) : e;
            return this.multiply(u, c).sum(l, !0);
        }
        var h = bt(t.dtype, e.dtype), p = new ui(t.shape, [
            s,
            o,
            a
        ], n, r), f = this.makePackedTensor(p.outputShape, h);
        return this.compileAndRun(p, [
            t,
            e
        ], f);
    }, t.prototype.fusedBatchMatMul = function(t, e, n, r, o, a) {
        var i = n ? t.shape[2] : t.shape[1], s = r ? e.shape[1] : e.shape[2], u = t.shape[0], l = bt(t.dtype, e.dtype), c = new ui(t.shape, [
            u,
            i,
            s
        ], n, r, !!o, a ? function(t, e) {
            if (void 0 === e && (e = !1), "linear" === t) return e ? Yi : zi;
            if ("relu" === t) return e ? Qi : Vi;
            throw new Error("Activation " + t + " has not been implemented for the WebGL backend.");
        }(a, !0) : null), h = this.makePackedTensor(c.outputShape, l), p = [
            t,
            e
        ];
        ...
        if ("complex64" === t.dtype) {
            var n = this.texData.get(t.dataId), r = this.texData.get(e.dataId), o = new $o(qo, t.shape, e.shape), a = new $o(Ho, t.shape, e.shape), i = [
            ...
            ], u = this.compileAndRun(o, i), l = this.compileAndRun(a, i), c = this.complex(u, l);
        ...
        var h = new Yo(Xo, t.shape, e.shape), p = this.makeOutputArray(h.outputShape, t.dtype);
        ...
        var r = e.reduce(function(t, e) {
            return t * e;
        }), o = xr(t.shape, e, r), a = br(o.length, e.length), i = wr(t.shape, e, r), s = Cr(n, e.length), u = Er(i, n, e.length);
        ...
        var i = t.pad(o), s = xr(i.shape, e, r, !1), u = br(s.length, e.length, !1), l = wr(i.shape, e, r, !1);
        return i.reshape(s).transpose(u).reshape(l);
    }, t.prototype.reduce = function(t, e, n) {
        var r = t.shape[0], o = t.shape[1], a = Sr(o), i = new vi({
            windowSize: a,
            inSize: o,
            batchSize: r
        }, e), s = i.outputShape, u = s[0], l = s[1], c = this.makeOutputArray([
            u,
            l
        ], n);
        return this.compileAndRun(i, [
            t
        ], c), 1 === c.shape[1] ? c : this.reduce(c, e, n);
        ...
        var a = Sr(o), i = new wo({
            ...
            inSize: o,
            batchSize: r
        }, e, null == n), s = i.outputShape, u = s[0], l = s[1], c = this.makeOutputArray([
            u,
            l
        ], "int32"), h = [
            t
        ...
        void 0 === n && (n = null);
        var r = null != n ? n.shape : t.shape, o = Sr(r[r.length - 1]), a = new Uo(r, o, e, null == n), i = this.makePackedTensor(a.outputShape, "int32"), s = null == n ? [
            t
        ] : [
            t,
            n
        ...
        nn("sum", e, t.rank);
        var n = tn(t.shape, e), r = n[0], o = y(n[1]), a = t.as2D(-1, o), i = wt(t.dtype);
        ...
        var i = function(t, e, n) {
            ...
            a.shape[r]
        ]), u = a.as2D(-1, s), l = wt(t.dtype), c = this.segOpCompute(u, "unsortedSegmentSum", e, l, n).reshape(i);
        ...
        var a = t.shape[0], i = t.shape[1], s = function(t, e) {
            ...
            batchSize: a,
            numSegments: o
        }, e), l = u.outputShape, c = l[0], h = l[1], p = this.makeOutputArray([
            c,
            h
        ], r);
        ...
        if (nn("arg" + n.charAt(0).toUpperCase() + n.slice(1), r, t.rank), !s.getBool("WEBGL_PACK_REDUCE") || t.rank <= 2) {
            var o = tn(t.shape, r), a = o[0], i = y(o[1]), u = t.as2D(-1, i);
        ...
        var n = new Yo("return float(a == b);", t.shape, e.shape), r = this.makeOutputArray(n.outputShape, "bool");
        return this.compileAndRun(n, [
            t,
            e
        ], r);
        ...
        var n = new Yo("return float(a >= 1.0 && b >= 1.0);", t.shape, e.shape), r = this.makeOutputArray(n.outputShape, "bool");
        return this.compileAndRun(n, [
            t,
            e
        ], r);
        ...
        var r = new Si(t.rank, e.shape, e.rank), o = this.makeOutputArray(r.outputShape, bt(e.dtype, n.dtype));
        return this.compileAndRun(r, [
            t,
            e,
            n
        ...
        nn("min", e, t.rank);
        var n = tn(t.shape, e), r = n[0], o = y(n[1]), a = t.as2D(-1, o);
        ...
        var r = new Yo(jo, t.shape, e.shape), o = this.makeOutputArray(r.outputShape, n);
        return this.compileAndRun(r, [
            t,
            e
        ], o);
        ...
        void 0 === o && (o = !1);
        var a = new Qo(n, t.shape, e.shape, o), i = this.makePackedTensor(a.outputShape, r);
        return this.compileAndRun(a, [
            t,
            e
        ], i);
        ...
        var r = this, o = this.texData.get(t.dataId), a = this.texData.get(e.dataId), i = [
            ...
            var a = o[0], i = o[1], s = r.makeComplexComponentTensorHandle(t, a), u = r.makeComplexComponentTensorHandle(e, i), l = new Yo(n, t.shape, e.shape), c = r.makeOutputArray(l.outputShape, bt(a.dtype, i.dtype));
            return r.compileAndRun(l, [
                s,
                u
            ], c);
        ...
        var o = t.map(function(t) {
            ...
            return t.shape;
        }), i = s.getBool("WEBGL_PACK"), u = i ? new bo(t[0].shape, a) : new xo(t[0].shape, a), l = i ? this.makePackedTensor(u.outputShape, o) : this.makeOutputArray(u.outputShape, o);
        ...
        var r = new Yo(Ko, t.shape, e.shape), o = this.makeOutputArray(r.outputShape, n);
        return this.compileAndRun(r, [
            t,
            e
        ], o);
    }, t.prototype.pow = function(t, e) {
        var n = s.getBool("WEBGL_PACK_BINARY_OPERATIONS"), r = n ? new Qo("\n  // isModRound1 has 1 for components with round(mod(b, 2.0)) == 1, 0 otherwise.\n  vec4 isModRound1 = vec4(equal(round(mod(b, 2.0)), ivec4(1)));\n  vec4 multiplier = sign(a) * isModRound1 + (vec4(1.0) - isModRound1);\n  vec4 result = multiplier * pow(abs(a), b);\n\n  vec4 isNaN = vec4(lessThan(a, vec4(0.0))) * vec4(lessThan(floor(b), b));\n  \n  result.r = isNaN.r > 0. ? NAN : result.r;\n  result.g = isNaN.g > 0. ? NAN : result.g;\n  result.b = isNaN.b > 0. ? NAN : result.b;\n  result.a = isNaN.a > 0. ? NAN : result.a;\n\n  return result;\n", t.shape, e.shape) : new Yo("\nif(a < 0.0 && floor(b) < b){\n  return NAN;\n}\nreturn (round(mod(b, 2.0)) != 1) ?\n    pow(abs(a), b) : sign(a) * pow(abs(a), b);\n", t.shape, e.shape), o = bt(t.dtype, e.dtype), a = n ? this.makePackedTensor(r.outputShape, o) : this.makeOutputArray(r.outputShape, o);
        return this.compileAndRun(r, [
            t,
            e
        ], a);
        ...
        var e = new Wi(t.shape, "return float(isnan(x));"), n = this.makeOutputArray(e.outputShape, "bool");
        return this.compileAndRun(e, [
            t
        ], n);
    }, t.prototype.isInf = function(t) {
        var e = new Wi(t.shape, "return float(isinf(x));"), n = this.makeOutputArray(e.outputShape, "bool");
        return this.compileAndRun(e, [
            t
        ], n);
    }, t.prototype.isFinite = function(t) {
        var e = new Wi(t.shape, "return float(!isnan(x) && !isinf(x));"), n = this.makeOutputArray(e.outputShape, "bool");
        return this.compileAndRun(e, [
            t
        ], n);
    }, t.prototype.round = function(t) {
        ...
        var e;
        return e = s.getBool("WEBGL_PACK") ? new Ji(t.shape, qi) : new Wi(t.shape, qi), this.compileAndRun(e, [
            t
        ]);
    }, t.prototype.expm1 = function(t) {
        ...
        var e;
        return e = s.getBool("WEBGL_PACK") ? new Ji(t.shape, Qi) : new Wi(t.shape, Vi), this.compileAndRun(e, [
            t
        ]);
    }, t.prototype.prelu = function(t, e) {
        ...
        var e = new Wi(t.shape, "return float(int(x));"), n = this.makeOutputArray(e.outputShape, "int32");
        return this.compileAndRun(e, [
            t
        ], n);
    }, t.prototype.clip = function(t, e, n) {
        var r, o = (r = s.getBool("WEBGL_PACK_CLIP") ? new Zo(t.shape) : new Jo(t.shape)).getCustomSetupFunc(e, n);
        return this.compileAndRun(r, [
            t
        ], null, o);
    }, t.prototype.abs = function(t) {
        ...
        var e = this.texData.get(t.dataId), n = new ta(t.shape), r = [
        ...
        var r = t.shape, o = this.texData.get(t.dataId), a = n.inChannels, i = r[0] * r[1] * r[2], u = n.outChannels, l = (1 === i || 1 === u) && a > 1e3, c = r[2] % 2 != 0 && !!o.isPacked;
        if (l || !s.getBool("WEBGL_LAZILY_UNPACK") || !s.getBool("WEBGL_PACK_BINARY_OPERATIONS") || !c) {
            var h = this.reshape(t, [
                1,
                r[0] * r[1] * r[2],
                n.inChannels
            ]), p = this.reshape(e, [
        ...
        var m = this.reshape(e, [
            1,
            n.inChannels,
            n.outChannels
        ]), g = this.batchMatMul(f, m, !1, !1), y = this.texData.get(g.dataId);
        ...
        var r = n.filterWidth, o = n.filterHeight, a = n.inChannels, i = n.outWidth, s = n.outHeight, u = r * o * a, l = s * i, c = [
            ...
            u,
            -1
        ]), f = new ri(c, h.shape, n), d = this.compileAndRun(f, [
            h
        ]).reshape([
            1,
            c[0],
        ...
        var r;
        return s.getBool("WEBGL_PACK_DEPTHWISECONV") && n.strideWidth <= 2 && n.outChannels / n.inChannels == 1 ? (r = new pa(n), this.compileAndRun(r, [
            t,
            e
        ], this.makePackedTensor(n.outShape, t.dtype))) : (r = new ha(n), this.compileAndRun(r, [
            t,
            e
        ]));
    }, t.prototype.depthwiseConv2DDerInput = function(t, e, n) {
        ...
        var n = new di(e, "max", !1), r = this.makeOutputArray(n.outputShape, t.dtype);
        return this.compileAndRun(n, [
            t
        ], r);
    }, t.prototype.avgPool = function(t, e) {
        var n = new di(e, "avg", !1), r = this.makeOutputArray(n.outputShape, "float32");
        return this.compileAndRun(n, [
            t
        ], r);
    }, t.prototype.maxPoolBackprop = function(t, e, n, r) {
        var o = new di(r, "max", !0), a = this.compileAndRun(o, [
            e
        ]), i = new si(r), s = this.makeOutputArray(i.outputShape, e.dtype), u = this.compileAndRun(i, [
            t,
            a
        ], s);
        return a.dispose(), u;
    }, t.prototype.avgPoolBackprop = function(t, e, n) {
        var r = new zo(n), o = this.makeOutputArray(r.outputShape, e.dtype);
        return this.compileAndRun(r, [
            t
        ], o);
    }, t.prototype.cast = function(t, e) {
        ...
        var o = e ? t : zr(t), a = o.shape[0], i = o.shape[1], s = new li(a, i, n), u = this.makeOutputArray(s.outputShape, "int32"), l = s.getCustomSetupFunc(r);
        return this.compileAndRun(s, [
            o
        ], u, l);
    }, t.prototype.oneHot = function(t, e, n, r) {
        ...
        var r = t.shape[0], o = "NHWC" === n ? t.shape[1] : t.shape[2], a = "NHWC" === n ? t.shape[2] : t.shape[3], i = "NHWC" === n ? t.shape[3] : t.shape[1], s = o * e, u = a * e, l = i / (e * e), c = new ya("NHWC" === n ? [
            r,
            s,
            u,
            l
        ...
        var r = kr(0, t, n), o = r.sliceRank, a = r.numUpdates, i = r.sliceSize, s = r.strides, u = r.outputSize, l = [
            u / i,
            i
        ], c = t.reshape([
            a,
        ...
        var p = vn(0), f = new Ri(a, o, c.rank, h.rank, s, l);
        ...
        var o = kr(0, t, n), a = o.sliceRank, i = o.numUpdates, s = o.strides, u = o.outputSize, l = new Ri(i, a, t.rank, e.rank, s, [
            u,
            1
        ], !1);
        ...
        var n = this.texData.get(t.dataId), r = new Ia(Ea, t.shape, e), o = new Ia(Ra, t.shape, e), a = [
            this.makeComplexComponentTensorHandle(t, n.complexTensors.real),
            this.makeComplexComponentTensorHandle(t, n.complexTensors.imag)
        ...
        var n = e.shape, r = n[n.length - 1], o = Rr(t, e), a = o[0], i = o[1], s = o[2], u = o[3], l = e.reshape([
            i,
            r
        ]), c = t.reshape([
            t.size / s,
        ...
        var o = new Sa(t, e), a = o.getCustomSetupFunc(e), i = this.makeOutputArray(t, n);
        ...
        return this.compileAndRun(e, [
            t
        ], ht.make(e.outputShape, {}, t.dtype, this));
    }, t.prototype.packTensor = function(t) {
        var e = new hi(t.shape);
        return this.compileAndRun(e, [
            t
        ], this.makePackedTensor(t.shape, t.dtype), null, !0);
    }, t.prototype.packedReshape = function(t, e) {
        var n = t.reshape([
            he(t.shape)
        ].concat(pe(t.shape))), r = [
            he(e)
        ].concat(pe(e)), o = new mi(r, n.shape);
        return this.compileAndRun(o, [
            n
        ]).reshape(e);
    }, t.prototype.decode = function(t) {
        var e, n = this.texData.get(t), r = n.isPacked, o = n.shape, a = n.dtype, i = fe(o), s = Fa(o), u = this.makeTensorHandle(o, "float32");
        ...
        var i = e.map(function(e) {
            ...
            else if (n.isPacked && !me(n.shape, e.shape)) {
                var r = e, o = e.shape;
        ...
        var u, l = {
            ...
            return a += "_" + r + "_" + o;
        }(t, i, l), h = this.getAndSaveBinary(c, function() {
            return function(t, e, n, r) {
                var o = e.userCode, a = n.map(function(t, n) {
                    ...
                    flatOffset: null
                }, l = ko(a, u, o, e.usesPackedTextures), c = t.createProgram(l), h = null, p = t.getUniformLocation(c, "NAN", !1);
        ...
        return p && (u = this.startTimer()), function(t, e, n, r, o) {
            ni(e.inShapeInfos, n), ni([
                e.outShapeInfo
            ], [
                r
            ]);
            var a = r.texData.texture, i = r.texData.texShape;
            r.texData.isPacked ? t.setOutputPackedMatrixTexture(a, i[0], i[1]) : t.setOutputMatrixTexture(a, i[0], i[1]), t.setProgram(e.webGLProgram), 1 === s.getNumber("WEBGL_VERSION") && null !== e.infLoc && t.gl.uniform1f(e.infLoc, 1 / 0), null !== e.nanLoc && t.gl.uniform1f(e.nanLoc, NaN), n.forEach(function(n, r) {
                ...
                if (null != a) if (n.isUniform) if (y(n.shape) < 2) t.gl.uniform1f(a, n.uniformValues[0]);
                else {
        ...
        if (null == i) {
            ...
            if (null == h && (h = de(r, u), n.texShape = h), null != a) {
                var p = fe(r), f = void 0, d = h[1], v = h[0], m = a instanceof Uint8Array;
                u ? (d = (e = Ma(h[0], h[1]))[0], v = e[1], f = new Ca(p, [
                    v,
                    d
                ], m)) : f = new wa(p, [
                    v,
                ...
                x.size = y(f.outputShape), this.texData.get(x.dataId).isPacked = u, this.compileAndRun(f, [
                    g
                ], x);
...
function Ls(t, e, n, r, o, a) {
    var i, s, u = Ye(t, "x", "batchNorm"), l = Ye(e, "mean", "batchNorm"), c = Ye(n, "variance", "batchNorm");
...
function zs(t, e, n, r, o, a) {
    null == a && (a = .001);
    var i, s, u, l = Ye(t, "x", "batchNorm"), c = Ye(e, "mean", "batchNorm"), h = Ye(n, "variance", "batchNorm");
    ...
    return At.runKernel(function(t, e) {
        ...
        var n = e, r = n[0], o = n[1], i = n[2], s = n[3], l = null == s ? vn(1) : s, c = $r(o.shape, u.shape), h = [];
        if (1 === o.rank) {
            for(var p = 0; p < u.shape.length - 1; ++p)h.push(u.shape[p]);
            h.push(1);
        }
        var f = r.sub(o), d = t.mul(l), v = Rs(i.add(vn(a))), m = v.mul(v).mul(v).mul(vn(-.5));
        return {
            $x: function() {
...
function Js(t, e, n, r, o, a) {
    ...
    var i = t, s = e, u = !1;
    3 === e.rank && (u = !0, s = e.as4D(1, e.shape[0], e.shape[1], e.shape[2]), i = [
        1,
        t[0],
        t[1],
        t[2]
    ...
    var h = Xr(i, n.shape, r, 1, o, a), p = At.runKernel(function(t, e) {
...
var eu = ln({
    conv1d_: function(t, e, n, r, o, a, i) {
        ...
        var s = Ye(t, "x", "conv1d"), u = Ye(e, "filter", "conv1d"), l = s, c = !1;
        ...
        var h = u.as4D(1, u.shape[0], u.shape[1], u.shape[2]), p = l.as4D(l.shape[0], 1, l.shape[1], l.shape[2]), f = nu(p, h, [
            1,
            n
        ], r, "NHWC", [
            1,
    ...
    conv2d_: function(t, e, n, r, o, a, i) {
        ...
        var s = Ye(t, "x", "conv2d"), u = Ye(e, "filter", "conv2d"), l = s, c = !1;
        ...
        var h = Xr(l.shape, u.shape, n, a, r, i), p = At.runKernel(function(t, e) {
    ...
    conv3d_: function(t, e, n, r, o, a) {
        ...
        var i = Ye(t, "x", "conv3d"), s = Ye(e, "filter", "conv3d"), u = i, l = !1;
        ...
        var c = Yr(u.shape, s.shape, n, a, r), h = At.runKernel(function(t, e) {
            ...
            return {
                x: function() {
                    return function(t, e, n, r, o) {
                        ...
                        var c = Yr(a, n.shape, r, 1, o), h = At.runKernel(function(t) {
    ...
    depthwiseConv2d_: function(t, e, n, r, o, a, i) {
        ...
        var s = Ye(t, "x", "depthwiseConv2d"), u = Ye(e, "filter", "depthwiseConv2d"), l = s, c = !1;
        3 === s.rank && (c = !0, l = s.as4D(1, s.shape[0], s.shape[1], s.shape[2])), d(4 === l.rank, function() {
        ...
        var h = Xr(l.shape, u.shape, n, a, r, i, !0), p = At.runKernel(function(t, e) {
    ...
    separableConv2d_: function(t, e, n, r, o, a, i) {
        ...
        var s = Ye(t, "x", "separableConv2d"), u = Ye(e, "depthwiseFilter", "separableConv2d"), l = Ye(n, "pointwiseFilter", "separableConv2d"), c = s, h = !1;
        ...
        var v = au(c, u, r, o, i, a), m = nu(v, l, 1, "valid", i);
...
var uu = ln({
    matMul_: function(t, e, n, r) {
        ...
        var a = Ye(t, "a", "matMul"), i = Ye(e, "b", "matMul");
        o = Ct(a, i), a = o[0], i = o[1];
        var s = n ? a.shape[a.rank - 2] : a.shape[a.rank - 1], u = r ? i.shape[i.rank - 1] : i.shape[i.rank - 2], l = n ? a.shape[a.rank - 1] : a.shape[a.rank - 2], c = r ? i.shape[i.rank - 2] : i.shape[i.rank - 1], h = a.shape.slice(0, -2), p = i.shape.slice(0, -2), f = y(h), v = y(p);
        ...
        var m = a.shape.slice(0, -2).concat([
            l,
            c
        ]), g = n ? a.as3D(f, s, l) : a.as3D(f, l, s), b = r ? i.as3D(v, c, u) : i.as3D(v, u, c);
        return At.runKernel(function(t, e) {
    ...
    dot_: function(t, e) {
        var n = Ye(t, "t1", "dot"), r = Ye(e, "t2", "dot");
    ...
    outerProduct_: function(t, e) {
        var n = Ye(t, "v1", "outerProduct"), r = Ye(e, "v2", "outerProduct");
...
function mu(t, e, n, r, o, a) {
    ...
    var l = Kr(s.shape, e, n, r, o, a), c = At.runKernel(function(t, e) {
        var n = t.maxPool(s, l);
        return e([
            s,
            n
        ...
        return {
            x: function() {
                return function(t, e, n, r, o, a, i, s) {
                    var u = Ye(t, "dy", "maxPoolBackprop"), l = Ye(e, "input", "maxPoolBackprop"), c = Ye(n, "output", "maxPoolBackprop");
...
function gu(t, e, n, r, o, a) {
    ...
    var l = Kr(s.shape, e, n, r, o, a), c = At.runKernel(function(t) {
        ...
        return {
            x: function() {
                return function(t, e, n, r, o, a) {
                    var i = Ye(t, "dy", "avgPoolBackprop"), s = Ye(e, "input", "avgPoolBackprop");
                    ...
                    var h = Kr(u.shape, n, r, o, a), p = At.runKernel(function(t) {
...
var yu = ln({
    ...
    pool_: function(t, e, n, r, o, a) {
        ...
        var p = 1 === h[0] && 1 === h[1], f = function(t, e, n) {
            ...
            c.inHeight,
            c.inWidth
        ], h, l), v = f[0], m = f[1], g = p ? r : "valid", y = p ? s : pr(s, h, v), x = ("avg" === n ? function() {
            return gu(y, e, a, 1, g);
        } : function() {
            return mu(y, e, a, 1, g);
        })(), b = p ? x : Kn(x, h, m);
...
var wu = ln({
    slice_: function(t, e, n) {
        var r, o, a = Ye(t, "x", "slice");
        if (0 === a.rank) throw new Error("Slicing scalar is not possible");
        r = "number" == typeof e ? [
            e
        ].concat(new Array(a.rank - 1).fill(0)) : e.length < a.rank ? e.concat(new Array(a.rank - e.length).fill(0)) : e.slice(), o = (o = null == n ? new Array(a.rank).fill(-1) : "number" == typeof n ? [
            n
...
var Nu = ln({
    all_: function(t, e, n) {
        ...
        var r = Ye(t, "x", "all", "bool"), o = S(e, r.shape), a = o, i = rn(a, r.rank);
    ...
    any_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = Ye(t, "x", "any", "bool"), o = S(e, r.shape), a = o, i = rn(a, r.rank);
        null != i && (r = r.transpose(i), a = an(a.length, r.rank));
        var s = At.runKernel(function(t) {
            return t.any(r, a);
        }, {
    ...
    argMax_: function(t, e) {
        ...
        var n = Ye(t, "x", "argMax");
        null == e && (e = 0);
        var r = S(e, n.shape), o = rn(r, n.rank);
    ...
    logSumExp_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = Ye(t, "x", "logSumExp"), o = S(e, r.shape), a = r.max(o, !0), i = r.sub(a).exp().sum(o).log(), s = a.reshape(i.shape).add(i);
        if (n) {
            var u = en(s.shape, o);
            return s.reshape(u);
        }
    ...
    max_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = Ye(t, "x", "max"), o = r, a = S(e, r.shape), i = a, s = rn(i, r.rank);
    ...
    mean_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = Ye(t, "x", "mean"), o = S(e, r.shape), a = y(tn(r.shape, o)[1]);
    ...
    min_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = Ye(t, "x", "min"), o = r, a = S(e, r.shape), i = a, s = rn(i, r.rank);
        null != s && (r = r.transpose(s), i = an(i.length, r.rank));
        var u = At.runKernel(function(t, e) {
            var n = t.min(r, i);
            return e([
    ...
    moments_: function(t, e, n) {
        void 0 === e && (e = null), void 0 === n && (n = !1);
        var r = S(e, (t = Ye(t, "x", "moments")).shape), o = t.mean(r, n), a = o.shape;
        n || (a = en(o.shape, r));
    ...
    prod_: function(t, e, n) {
        ...
        var r = Ye(t, "x", "prod");
        "bool" === r.dtype && (r = r.toInt());
        var o = S(e, r.shape), a = rn(o, r.rank), i = o, s = r;
...
var Lu = ln({
    equal_: function(t, e) {
        var n, r = Ye(t, "a", "equal"), o = Ye(e, "b", "equal");
    ...
    equalStrict_: function(t, e) {
        var n = Ye(t, "a", "equalStrict"), r = Ye(e, "b", "equalStrict");
        return v(n.shape, r.shape, "Error in equalStrict: "), n.equal(r);
    }
}), Uu = ln({
    greater_: function(t, e) {
        var n, r = Ye(t, "a", "greater"), o = Ye(e, "b", "greater");
        return n = Ct(r, o), r = n[0], o = n[1], jr(r.shape, o.shape), At.runKernel(function(t) {
    ...
    greaterEqual_: function(t, e) {
        var n, r = Ye(t, "a", "greaterEqual"), o = Ye(e, "b", "greaterEqual");
    ...
    lessEqual_: function(t, e) {
        var n, r = Ye(t, "a", "lessEqual"), o = Ye(e, "b", "lessEqual");
        return n = Ct(r, o), r = n[0], o = n[1], jr(r.shape, o.shape), At.runKernel(function(t) {
    ...
    notEqualStrict_: function(t, e) {
        var n = Ye(t, "a", "notEqualStrict"), r = Ye(e, "b", "notEqualStrict");
        return v(n.shape, r.shape, "Error in notEqualStrict: "), n.notEqual(r);
    }
});
var Yu = ln({
    add_: function(t, e) {
        var n, r = Ye(t, "a", "add"), o = Ye(e, "b", "add");
    ...
    addStrict_: function(t, e) {
        var n = Ye(t, "a", "addStrict"), r = Ye(e, "b", "addStrict");
        return v(n.shape, r.shape, "Error in addStrict: "), n.add(r);
    }
}), Zu = ln({
    atan2_: function(t, e) {
        var n, r = Ye(t, "a", "atan2"), o = Ye(e, "b", "atan2");
        n = Ct(r, o), r = n[0], o = n[1];
        var a = jr(r.shape, o.shape);
        return At.runKernel(function(t, e) {
            var n = t.atan2(r, o);
            ...
            return {
                $a: function() {
                    var e = Yu(n.square(), r.square()), o = t.mul(r.div(e)), i = $r(n.shape, a);
                    return i.length > 0 && (o = o.sum(i)), o.reshape(n.shape);
                },
                $b: function() {
                    var e = Yu(n.square(), r.square()), o = ws(t.mul(n.div(e))), i = $r(r.shape, a);
    ...
    div_: function(t, e) {
        var n, r = Ye(t, "a", "div"), o = Ye(e, "b", "div");
        ...
        return At.runKernel(function(t, e) {
            ...
            return {
                $a: function() {
                    var e = t.div(r.toFloat()), o = $r(n.shape, a);
                    return o.length > 0 ? e.sum(o).reshape(n.shape) : e;
                },
                $b: function() {
                    var e = t.mul(n.toFloat()), o = $r(r.shape, a);
    ...
    maximum_: function(t, e) {
        var n, r = Ye(t, "a", "maximum"), o = Ye(e, "b", "maximum");
    ...
    maximumStrict_: function(t, e) {
        var n = Ye(t, "a", "maximumStrict"), r = Ye(e, "b", "maximumStrict");
        return v(n.shape, r.shape, "Error in maximumStrict: "), n.maximum(r);
    }
}), al = ln({
    minimum_: function(t, e) {
        var n, r = Ye(t, "a", "minimum"), o = Ye(e, "b", "minimum");
        return n = Ct(r, o), r = n[0], o = n[1], "bool" === r.dtype && (r = r.toInt(), o = o.toInt()), jr(r.shape, o.shape), At.runKernel(function(t, e) {
            var n = t.minimum(r, o);
            return e([
                r,
    ...
    minimumStrict_: function(t, e) {
        var n = Ye(t, "a", "minimumStrict"), r = Ye(e, "b", "minimumStrict");
        return v(n.shape, r.shape, "Error in minimumStrict: "), n.minimum(r);
    }
}), sl = ln({
    mod_: function(t, e) {
        var n, r = Ye(t, "a", "mod"), o = Ye(e, "b", "mod");
        n = Ct(r, o), r = n[0], o = n[1];
        var a = jr(r.shape, o.shape);
        return At.runKernel(function(t, e) {
            var n = t.mod(r, o);
            ...
            return {
                ...
                $b: function() {
                    var e = t.mul(n.div(r).floor().neg()), o = $r(r.shape, a);
    ...
    modStrict_: function(t, e) {
        var n = Ye(t, "a", "modStrict"), r = Ye(e, "b", "modStrict");
        return v(n.shape, r.shape, "Error in modStrict: "), n.mod(r);
    }
}), ll = ln({
    mul_: function(t, e) {
        var n, r = Ye(t, "a", "mul"), o = Ye(e, "b", "mul");
        n = Ct(r, o), r = n[0], o = n[1];
        var a = jr(r.shape, o.shape);
        return At.runKernel(function(t, e) {
            ...
            return {
                $a: function() {
                    var e = t.mul(r.toFloat()), o = $r(n.shape, a);
                    return o.length > 0 ? e.sum(o).reshape(n.shape) : e;
                },
                $b: function() {
                    var e = t.mul(n.toFloat()), o = $r(r.shape, a);
    ...
    mulStrict_: function(t, e) {
        var n = Ye(t, "a", "mul"), r = Ye(e, "b", "mul");
        return v(n.shape, r.shape, "Error in multiplyStrict: "), n.mul(r);
    }
}), hl = ln({
    pow_: function(t, e) {
        var n = Ye(t, "base", "pow"), r = Ye(e, "exp", "pow"), o = jr(n.shape, r.shape);
        return t = n.cast(bt(n.dtype, r.dtype)), e = r.cast(bt(n.dtype, r.dtype)), At.runKernel(function(t, e) {
            ...
            return {
                $base: function() {
                    var e = r.toFloat(), a = t.mul(e.mul(n.pow(e.sub(vn(1))))), i = $r(n.shape, o);
                    return i.length > 0 && (a = a.sum(i)), a.reshape(n.shape);
                },
                $exp: function() {
                    var e = n.greater(0), i = n.log().where(e, kn(n)), s = t.mul(a.mul(i)), u = $r(r.shape, o);
    ...
    squaredDifference_: function(t, e) {
        var n, r = Ye(t, "a", "squaredDifference"), o = Ye(e, "b", "squaredDifference");
        return n = Ct(r, o), r = n[0], o = n[1], jr(r.shape, o.shape), At.runKernel(function(t, e) {
    ...
    squaredDifferenceStrict_: function(t, e) {
        var n = Ye(t, "a", "squaredDifferenceStrict"), r = Ye(e, "b", "squaredDifferenceStrict");
        return v(n.shape, r.shape, "Error in squaredDifferenceStrict: "), n.squaredDifference(r);
    }
}), vl = ln({
    sub_: function(t, e) {
        var n, r = Ye(t, "a", "sub"), o = Ye(e, "b", "sub");
        n = Ct(r, o), r = n[0], o = n[1];
        var a = jr(r.shape, o.shape);
        return At.runKernel(function(t) {
    ...
    subStrict_: function(t, e) {
        var n = Ye(t, "a", "subStrict"), r = Ye(e, "b", "subStrict");
        return v(n.shape, r.shape, "Error in subStrict: "), n.sub(r);
    }
});
var gl = ln({
    logicalAnd_: function(t, e) {
        var n = Ye(t, "a", "logicalAnd", "bool"), r = Ye(e, "b", "logicalAnd", "bool");
    ...
    logicalOr_: function(t, e) {
        var n = Ye(t, "a", "logicalOr", "bool"), r = Ye(e, "b", "logicalOr", "bool");
        return jr(n.shape, r.shape), At.runKernel(function(t) {
    ...
    logicalXor_: function(t, e) {
        var n = Ye(t, "a", "logicalXor", "bool"), r = Ye(e, "b", "logicalXor", "bool");
        return jr(n.shape, r.shape), xl(t, e).logicalAnd(gl(t, e).logicalNot());
    }
}), wl = ln({
    where_: function(t, e, n) {
        var r = Ye(e, "a", "where"), o = Ye(n, "b", "where"), a = Ye(t, "condition", "where", "bool");
        ...
        return o(this, function(o) {
            switch(o.label){
                case 0:
                    return [
                        4,
                        (e = Ye(t, "condition", "whereAsync", "bool")).data()
                    ];
                case 1:
                    return n = o.sent(), r = yo(e.shape, n), t !== e && e.dispose(), [
                        2,
                        r
                    ];
            }
...
var El = ln({
    ...
    prelu_: function(t, e) {
        var n = Ye(t, "x", "prelu"), r = Ye(e, "alpha", "prelu");
        return At.runKernel(function(t, e) {
            var o = t.prelu(n, r);
            return e([
                n,
            ...
            return {
                ...
                $alpha: function() {
                    var e = wl(o, kn(t), t.mul(n)), a = $r(r.shape, t.shape);
    ...
    selu_: function(t) {
        ...
        return At.runKernel(function(t, n) {
            ...
            return {
                $x: function() {
                    var e = n.greater(vn(0)), r = vn(Pi), o = vn(Li), a = t.mul(o), i = t.mul(r).mul(n.toFloat().exp());
                    return wl(e, a, i);
                }
            };
        });
...
var Ol = ln({
    gather_: function(t, e, n) {
        void 0 === n && (n = 0);
        var r = Ye(t, "x", "gather"), o = Ye(e, "indices", "gather", "int32");
        n = S(n, r.shape)[0];
        ...
        return At.runKernel(function(t, e) {
            ...
            return {
                $x: function() {
                    var e = r.shape, a = o.size, i = e.slice(0, n), s = i.length, u = e.slice(n, e.length).slice(1), l = u.length, c = Dl(0, s), h = Dl(s + 1, s + 1 + l), p = _l([
                        i,
                        [
                            a
                        ],
                        u
                    ]), f = t.reshape(p), d = o.reshape([
                        a
                    ]), v = _l([
                        [
                            s
                        ...
                        c,
                        h
                    ]), m = f.transpose(v), g = Fl(m, d, r.shape[n]), y = on(v);
    ...
    unsortedSegmentSum_: function(t, e, n) {
        var r = Ye(t, "x", "unsortedSegmentSum"), o = Ye(e, "segmentIds", "unsortedSegmentSum", "int32");
...
var Ml = ln({
    basicLSTMCell_: function(t, e, n, r, o, a) {
        var i = Ye(t, "forgetBias", "basicLSTMCell"), s = Ye(e, "lstmKernel", "basicLSTMCell"), u = Ye(n, "lstmBias", "basicLSTMCell"), l = Ye(r, "data", "basicLSTMCell"), c = Ye(o, "c", "basicLSTMCell"), h = Ye(a, "h", "basicLSTMCell"), p = l.concat(h, 1).matMul(s).add(u), f = p.shape[0], d = p.shape[1] / 4, v = [
            f,
            d
        ], m = p.slice([
            0,
            ...
            0,
            3 * d
        ], v), b = m.sigmoid().mulStrict(g.tanh()).addStrict(c.mulStrict(i.add(y).sigmoid())), w = b.tanh().mulStrict(x.sigmoid());
        return [
            b,
            w
        ];
...
var Pl = ln({
    movingAverage_: function(t, e, n, r, o) {
        void 0 === o && (o = !0);
        var a = Ye(t, "v", "movingAverage"), i = Ye(e, "x", "movingAverage"), s = Ye(n, "decay", "movingAverage");
        Et(a, i), d(x(a.shape, i.shape), function() {
            return "Shape mismatch in v and x";
        });
        var u = vn(1), l = u.sub(s), c = i.sub(a).mul(l);
        if (o) {
            d(null != r, function() {
...
var Ll = ln({
    stridedSlice_: function(t, e, n, r, o, a, i, s, u) {
        ...
        if (r.every(function(t) {
            ...
            var c = Ar(l.shape, e, n, r, o, a, i, s, u), h = c[0], p = c[1], f = c[2], d = p.filter(function(t, e) {
...
var Ul = ln({
    scatterND_: function(t, e, n) {
        var r = Ye(t, "indices", "scatterND", "int32"), o = Ye(e, "updates", "scatterND");
...
var zl = ln({
    ...
    rfft_: function(t, e) {
        ...
        var u = n.zerosLike(), l = cn(n, u).as2D(o, r), c = zl(l), h = Math.floor(r / 2) + 1, p = hn(c), f = pn(c), v = p.split([
            h,
            r - h
        ], p.shape.length - 1), m = f.split([
            h,
            r - h
        ], f.shape.length - 1), g = n.shape.slice();
    ...
    irfft_: function(t) {
        ...
        if (e <= 2) {
            var r = t.as2D(n, e), o = Vl(r);
            return hn(o);
        }
        var a = [
            n,
            2 * (e - 1)
        ], i = hn(t).as2D(n, e), s = pn(t).as2D(n, e), u = i.slice([
            0,
            1
        ], [
            n,
            ...
            n,
            e - 2
        ]).reverse(1).mul(vn(-1)), c = i.concat(u, 1), h = s.concat(l, 1);
...
var $l = ln({
    sparseToDense_: function(t, e, n, r) {
        void 0 === r && (r = 0);
        var o = Ye(t, "sparseIndices", "sparseToDense", "int32"), a = Ye(e, "sparseValues", "sparseToDense"), i = Ye(r, "defaultValue", "sparseToDense", a.dtype);
        return function(t, e, n, r) {
...
var jl = ln({
    gatherND_: function(t, e) {
        var n = Ye(e, "indices", "gatherND", "int32"), r = Ye(t, "x", "gatherND");
        return At.runKernel(function(t) {
...
var Yl, Ql = ln({
    ...
    frame_: function(t, e, n, r, o) {
        ...
        return 0 === i.length ? gn([], [
            0,
            e
        ]) : An(i).as2D(i.length, e);
    }
}), tc = Object.freeze({
    hannWindow: Ql,
    hammingWindow: Jl,
...
var ec = ln({
    absoluteDifference_: function(t, e, n, r) {
        ...
        var o = Ye(t, "labels", "absoluteDifference"), a = Ye(e, "predictions", "absoluteDifference"), i = null;
    ...
    computeWeightedLoss_: function(t, e, n) {
        ...
        var r = Ye(t, "losses", "computeWeightedLoss"), o = null;
    ...
    cosineDistance_: function(t, e, n, r, o) {
        ...
        var a = Ye(t, "labels", "cosineDistance"), i = Ye(e, "predictions", "cosineDistance"), s = null;
    ...
    hingeLoss_: function(t, e, n, r) {
        void 0 === r && (r = Yl.SUM_BY_NONZERO_WEIGHTS);
        var o = Ye(t, "labels", "hingeLoss"), a = Ye(e, "predictions", "hingeLoss"), i = null;
    ...
    huberLoss_: function(t, e, n, r, o) {
        ...
        var a = Ye(t, "labels", "huberLoss"), i = Ye(e, "predictions", "huberLoss"), s = null;
        null != n && (s = Ye(n, "weights", "huberLoss")), v(a.shape, i.shape, "Error in huberLoss: ");
        var u = vn(r), l = i.sub(a).abs(), c = al(l, u), h = l.sub(c), p = vn(.5).mul(c.square()).add(u.mul(h));
        return nc(p, s, o);
    }
}), ic = ln({
    logLoss_: function(t, e, n, r, o) {
        void 0 === r && (r = 1e-7), void 0 === o && (o = Yl.SUM_BY_NONZERO_WEIGHTS);
        var a = Ye(t, "labels", "logLoss"), i = Ye(e, "predictions", "logLoss"), s = null;
        null != n && (s = Ye(n, "weights", "logLoss")), v(a.shape, i.shape, "Error in logLoss: ");
        var u = vn(1), l = vn(r), c = a.mul(i.add(l).log()).neg().sub(u.sub(a).mul(u.sub(i).add(l).log()));
        return nc(c, s, o);
    }
}), sc = ln({
    meanSquaredError_: function(t, e, n, r) {
        void 0 === r && (r = Yl.SUM_BY_NONZERO_WEIGHTS);
        var o = Ye(t, "labels", "meanSquaredError"), a = Ye(e, "predictions", "meanSquaredError"), i = null;
    ...
    sigmoidCrossEntropy_: function(t, e, n, r, o) {
        ...
        var a = Ye(t, "multiClassLabels", "sigmoidCrossEntropy"), i = Ye(e, "logits", "sigmoidCrossEntropy"), s = null;
        if (null != n && (s = Ye(n, "weights", "sigmoidCrossEntropy")), v(a.shape, i.shape, "Error in sigmoidCrossEntropy: "), r > 0) {
            var u = vn(r), l = vn(1), c = vn(.5);
            a = a.mul(l.sub(u)).add(c.mul(u));
        }
        var h = function(t, e) {
            var n = Ye(t, "labels", "sigmoidCrossEntropyWithLogits"), r = Ye(e, "logits", "sigmoidCrossEntropyWithLogits");
    ...
    softmaxCrossEntropy_: function(t, e, n, r, o) {
        void 0 === r && (r = 0), void 0 === o && (o = Yl.SUM_BY_NONZERO_WEIGHTS);
        var a = Ye(t, "onehotLabels", "softmaxCrossEntropy"), i = Ye(e, "logits", "softmaxCrossEntropy"), s = null;
        if (null != n && (s = Ye(n, "weights", "softmaxCrossEntropy")), v(a.shape, i.shape, "Error in softmaxCrossEntropy: "), r > 0) {
            var u = vn(r), l = vn(1), c = vn(a.shape[1]);
...
function hc(t, e) {
    return void 0 === e && (e = !1), At.tidy(function() {
        ...
        for(var n = t.shape[0], r = t.shape[1], o = tr(n), a = t.clone(), i = gn([
            [
                1
            ]
        ], [
            1,
            1
        ]), s = i.clone(), u = n >= r ? r : n, l = function(t) {
            var e, u = a, l = s, c = o;
            e = At.tidy(function() {
                var e = a.slice([
                    t,
                    ...
                    1,
                    1
                ]), c = l.sign().neg(), h = l.sub(c.mul(u)), p = e.div(h);
                s = 1 === p.shape[0] ? i.clone() : i.concat(p.slice([
                    1,
                    0
                ], [
                    p.shape[0] - 1,
                ...
                var f = c.matMul(h).div(u).neg(), d = a.slice([
                    t,
                    0
                ], [
                    n - t,
                ...
                a = 0 === t ? d.sub(v.matMul(s.transpose().matMul(d))) : a.slice([
                    0,
                    0
                ], [
                    t,
                    r
                ]).concat(d.sub(v.matMul(s.transpose().matMul(d))), 0);
                var m = o.slice([
                    0,
                    t
                ], [
                ...
                return o = 0 === t ? m.sub(m.matMul(s).matMul(v.transpose())) : o.slice([
                    0,
                    0
                ], [
                    n,
                    t
                ]).concat(m.sub(m.matMul(s).matMul(v.transpose())), 1), [
                    s,
                    a,
                    o
                ];
            }), s = e[0], a = e[1], o = e[2], Me([
                u,
                l,
                c
            ]);
...
var pc = ln({
    ...
    qr_: function(t, e) {
        ...
        return r.forEach(function(t) {
            var n = hc(t, e), r = n[0], i = n[1];
            o.push(r), a.push(i);
        }), [
            dr(o, 0).reshape(t.shape),
...
var mc = ln({
    resizeBilinear_: function(t, e, n) {
        ...
        var i = e[0], s = e[1], u = At.runKernel(function(t, e) {
            return e([
                o
    ...
    nonMaxSuppression_: function(t, e, n, r, o) {
        ...
        var a = Ye(t, "boxes", "nonMaxSuppression"), i = Ye(e, "scores", "nonMaxSuppression"), s = vc(a, i, n, r, o);
    ...
    return void 0 === a && (a = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), r(this, void 0, void 0, function() {
        ...
        return o(this, function(o) {
            switch(o.label){
                case 0:
                    return r = Ye(t, "boxes", "nonMaxSuppressionAsync"), s = Ye(e, "scores", "nonMaxSuppressionAsync"), u = vc(r, s, n, a, i), n = u.maxOutputSize, a = u.iouThreshold, i = u.scoreThreshold, [
                        4,
                        r.data()
                    ];
                case 1:
                ...
                case 2:
                    return c = o.sent(), h = po(l, c, n, a, i), r !== t && r.dispose(), s !== e && s.dispose(), [
                        2,
                        h
                    ];
            }
    ...
    cropAndResize_: function(t, e, n, r, o, a) {
        var i = Ye(t, "image", "cropAndResize", "float32"), s = Ye(e, "boxes", "cropAndResize", "float32"), u = Ye(n, "boxInd", "cropAndResize", "int32");
        o = o || "bilinear", a = a || 0;
        var l = s.shape[0];
...
var Cc = ln({
    matMul_: function(t, e, n, r, o, a) {
        ...
        var s = Ye(t, "a", "fused matMul"), u = Ye(e, "b", "fused matMul");
        i = Ct(s, u), s = i[0], u = i[1];
        var l = n ? s.shape[s.rank - 2] : s.shape[s.rank - 1], c = r ? u.shape[u.rank - 1] : u.shape[u.rank - 2], h = n ? s.shape[s.rank - 1] : s.shape[s.rank - 2], p = r ? u.shape[u.rank - 2] : u.shape[u.rank - 1], f = s.shape.slice(0, -2), v = u.shape.slice(0, -2), m = y(f), g = y(v);
        ...
        var b, w = s.shape.slice(0, -2).concat([
            h,
            p
        ]), C = n ? s.as3D(m, l, h) : s.as3D(m, h, l), E = r ? u.as3D(g, p, c) : u.as3D(g, c, p);
        ...
        return null != o && (R.$bias = b), At.runKernel(function(t, e) {
            ...
            var i, s = e[0], u = e[1], l = e[2];
            if (null == a || "linear" === a) i = t;
            else {
...
var Ic = function() {
    ...
    return t.prototype.register = function(t, e, n) {
        ...
        for(var o = n ? t.shape[1] : t.shape[2], a = n ? t.shape[2] : t.shape[1], i = r ? e.shape[1] : e.shape[2], s = t.shape[0], u = this.readSync(t.dataId), l = this.readSync(e.dataId), c = n ? [
            t.strides[0],
            1,
            t.strides[1]
        ] : [
            ...
            1,
            e.strides[0]
        ], v = d[0], m = d[1], g = d[2], y = a * i, x = $n([
            s,
            a,
            i
        ], t.dtype), b = x.values, w = this.blockSize, C = 0; C < s; C++)for(var E = 0; E < a; E += w)for(var R = 0; R < i; R += w)for(var I = 0; I < o; I += w)for(var S = Math.min(E + w, a), N = Math.min(R + w, i), k = Math.min(I + w, o), A = E; A < S; A++)for(var T = R; T < N; T++){
        ...
        for(a = 0; a < n; ++a){
            var i = vn(a, "int32"), s = Lu(i, e).asType("float32").mul(t).sum(0);
            r.push(s);
        }
        return dr(r);
    }, t.prototype.argMin = function(t, e) {
        ...
        var r = e.map(function(e, n) {
            ...
            return t[0];
        }), a = this.bufferSync(t), i = $n(r, t.dtype);
        0 !== n && i.values.fill(n);
        for(var s = 0; s < t.size; s++){
            var u = a.indexToLoc(s), l = u.map(function(t, e) {
                return t + o[e];
            });
            i.set.apply(i, [
                a.get.apply(a, u)
        ...
        var o = this.readSync(t.dataId), a = $n(n, t.dtype), i = this.bufferSync(t);
        for(r = 0; r < t.size; ++r){
        ...
        for(var o = t.shape, a = o[0], i = o[1], s = o[2], u = o[3], l = this.readSync(t.dataId), c = new Float32Array(y([
            a,
            e,
            n,
            u
            ...
            r && e > 1 ? e - 1 : e,
            r && n > 1 ? n - 1 : n
        ], f = 0, d = h[0] / p[0], v = h[1] / p[1], m = 0; m < a; m++)for(var g = 0; g < e; g++)for(var x = d * g, b = Math.floor(x), w = x - b, C = Math.min(i - 1, Math.ceil(x)), E = m * t.strides[0] + b * t.strides[1], R = m * t.strides[0] + C * t.strides[1], I = 0; I < n; I++)for(var S = v * I, N = Math.floor(S), k = S - N, A = Math.min(s - 1, Math.ceil(S)), T = E + N * t.strides[2], D = R + N * t.strides[2], _ = E + +A * t.strides[2], O = R + A * t.strides[2], F = 0; F < u; F++){
            var M = l[T + F], B = l[D + F], P = M + (l[_ + F] - M) * k, L = P + (B + (l[O + F] - B) * k - P) * w;
            c[f++] = L;
        }
        return fn(c, [
            a,
        ...
        for(var o = t.shape, a = o[0], i = o[1], s = o[2], u = o[3], l = this.readSync(t.dataId), c = new Float32Array(a * e * n * u), h = [
            r && e > 1 ? i - 1 : i,
            r && n > 1 ? s - 1 : s
        ], p = [
            r && e > 1 ? e - 1 : e,
            r && n > 1 ? n - 1 : n
        ], f = h[0] / p[0], d = h[1] / p[1], v = 0, m = 0; m < a; m++)for(var g = m * t.strides[0], y = 0; y < e; y++)for(var x = f * y, b = g + Math.min(i - 1, r ? Math.round(x) : Math.floor(x)) * t.strides[1], w = 0; w < n; w++)for(var C = d * w, E = b + Math.min(s - 1, r ? Math.round(C) : Math.floor(C)) * t.strides[2], R = 0; R < u; R++){
            var I = l[E + R];
            c[v++] = I;
        }
        return fn(c, [
        ...
        for(var r = e.shape, o = r[0], a = r[1], i = r[2], s = r[3], u = t.shape, l = u[1], c = u[2], h = new Float32Array(o * a * i * s), p = this.readSync(t.dataId), f = [
            n && l > 1 ? a - 1 : a,
            n && c > 1 ? i - 1 : i
        ], d = [
            n && l > 1 ? l - 1 : l,
            n && c > 1 ? c - 1 : c
        ], v = f[0] / d[0], m = f[1] / d[1], g = 1 / v, y = 1 / m, x = 2 * Math.ceil(g) + 2, b = 2 * Math.ceil(y) + 2, w = 0; w < o; w++)for(var C = w * e.strides[0], E = 0; E < a; E++)for(var R = C + E * e.strides[1], I = Math.floor(E * g), S = Math.floor(I - x / 2), N = 0; N < i; N++)for(var k = R + N * e.strides[2], A = Math.floor(N * y), T = Math.floor(A - b / 2), D = 0; D < s; D++){
            for(var _ = 0, O = 0; O < x; O++){
                var F = O + S;
                if (!(F < 0 || F >= l)) {
                    var M = C + F * t.strides[1], B = F * v;
        ...
        for(var i = this.readSync(t.dataId), s = this.readSync(e.dataId), u = this.readSync(n.dataId), l = o ? this.readSync(o.dataId) : new Float32Array([
            1
        ]), c = a ? this.readSync(a.dataId) : new Float32Array([
            0
        ]), h = new Float32Array(i.length), p = c.length, f = l.length, d = u.length, v = s.length, m = 0, g = 0, y = 0, x = 0, b = 0; b < i.length; ++b)h[b] = c[m++] + (i[b] - s[g++]) * l[y++] / Math.sqrt(u[x++] + r), m >= p && (m = 0), g >= v && (g = 0), y >= f && (y = 0), x >= d && (x = 0);
        return xn(h, t.shape);
    }, t.prototype.localResponseNormalization4D = function(t, e, n, r, o) {
        this.assertNotComplex(t, "localResponseNormalization4D");
        var a = t.shape[3], i = a - 1, s = this.readSync(t.dataId), u = t.size, l = new Float32Array(u);
        function c(t) {
        ...
        for(var h = 0; h < u; h++){
            var p = c(h), f = s[h] * Math.pow(n + r * p, -o);
            l[h] = f;
        }
        return xn(l, t.shape);
    }, t.prototype.LRNGrad = function(t, e, n, r, o, a, i) {
        ...
        for(var o = e ? t : zr(t), a = o.shape[0], i = o.shape[1], s = En([
            a,
            n
        ], "int32"), u = this.readSync(s.dataId), l = this.readSync(o.dataId), c = 0; c < a; ++c){
            var h = c * i, p = new Float32Array(i - 1);
            p[0] = l[h];
        ...
        for(var n = t.shape[0], r = t.shape[1], o = $n(t.shape, "float32"), a = $n(t.shape, "float32"), i = hn(t).as2D(n, r), s = pn(t).as2D(n, r), u = 0; u < n; u++)for(var l = i.slice([
            u,
            0
        ], [
            1,
            ...
            1,
            r
        ]), h = cn(l, c), p = this.readSync(this.fftImpl(h, e).dataId), f = 0; f < r; f++){
            var d = lo(p, f);
        ...
        }(r), i = cn(a.real, a.imag).as1D(), s = function(t) {
        ...
        var o = jr(t.shape, e.shape), a = $n(o, n), i = this.readSync(t.dataId), s = this.readSync(e.dataId), u = Hr(t.shape, o), l = Hr(e.shape, o), c = a.values;
        if (u.length + l.length === 0) for(var h = 0; h < c.length; ++h)c[h] = r(i[h % i.length], s[h % s.length]);
        else {
            var p = this.bufferSync(t), f = this.bufferSync(e), d = function(n) {
                var o = a.indexToLoc(n), h = o.slice(-t.rank);
                u.forEach(function(t) {
                    return h[t] = 0;
                });
                var d = p.locToIndex(h), v = o.slice(-e.rank);
        ...
        var r = jr(t.shape, e.shape), o = $n(r, "float32"), a = $n(r, "float32"), i = this.readSync(t.dataId), s = this.readSync(e.dataId), u = Hr(t.shape, r), l = Hr(e.shape, r), c = o.values, h = a.values;
        if (u.length + l.length === 0) for(var p = 0; p < c.length; p++){
            var f = p % i.length, d = p % s.length, v = n(i[2 * f], i[2 * f + 1], s[2 * d], s[2 * d + 1]);
            ...
            var m = this.bufferSync(this.data.get(t.dataId).complexTensors.real), g = this.bufferSync(this.data.get(e.dataId).complexTensors.real), y = function(r) {
                var a = o.indexToLoc(r), p = a.slice(-t.rank);
                u.forEach(function(t) {
                    return p[t] = 0;
                });
                var f = m.locToIndex(p), d = a.slice(-e.rank);
                l.forEach(function(t) {
                    return d[t] = 0;
                });
                var v = g.locToIndex(d), y = n(i[2 * f], i[2 * f + 1], s[2 * v], s[2 * v + 1]);
        ...
        for(var i = t.shape, s = i[0], u = i[1], l = i[2], c = i[3], h = e.shape[0], p = r[0], f = r[1], d = $n([
            h,
            p,
            f,
            c
        ], t.dtype), v = this.readSync(e.dataId), m = this.readSync(n.dataId), g = this.readSync(t.dataId), y = t.strides, x = d.strides, b = 0; b < h; b++){
            var w = 4 * b, C = v[w], E = v[w + 1], R = v[w + 2], I = v[w + 3], S = m[b];
            if (!(S >= s)) for(var N = p > 1 ? (R - C) * (u - 1) / (p - 1) : 0, k = f > 1 ? (I - E) * (l - 1) / (f - 1) : 0, A = 0; A < p; A++){
                ...
                if (T < 0 || T > u - 1) for(var D = 0; D < f; D++)for(var _ = 0; _ < c; _++){
                    ...
                    var F = Math.floor(T), M = Math.ceil(T), B = T - F;
                    for(D = 0; D < f; D++){
                        if ((H = f > 1 ? E * (l - 1) + D * k : .5 * (E + I) * (l - 1)) < 0 || H > l - 1) for(_ = 0; _ < c; _++){
                            ...
                            var P = Math.floor(H), L = Math.ceil(H), W = H - P;
                            for(_ = 0; _ < c; _++){
                                var U = g[O = _ + P * y[2] + F * y[1] + S * y[0]], z = g[O = _ + L * y[2] + F * y[1] + S * y[0]], V = g[O = _ + P * y[2] + M * y[1] + S * y[0]], G = U + (z - U) * W, q = V + (g[O = _ + L * y[2] + M * y[1] + S * y[0]] - V) * W;
                    ...
                    if ((H = f > 1 ? E * (l - 1) + D * k : .5 * (E + I) * (l - 1)) < 0 || H > l - 1) for(_ = 0; _ < c; _++){
                        ...
                        var $ = Math.round(H), j = Math.round(T);
                        for(_ = 0; _ < c; _++){
                            var K = _ + $ * y[2] + j * y[1] + S * y[0], X = _ + D * x[2] + A * x[1] + b * x[0];
                            d.values[X] = g[K];
                        }
                    }
                }
        ...
        var o = kr(0, t, n), a = o.sliceRank, i = o.numUpdates, s = o.sliceSize, u = o.strides, l = o.outputSize;
        return this.scatter(t, e, n, l, s, i, a, u, r, !1);
    }, t.prototype.gatherND = function(t, e) {
        var n = e.shape, r = n[n.length - 1], o = Rr(t, e), a = o[0], i = o[1], s = o[2], u = o[3];
        if (0 === i) return fn([], a, t.dtype);
        for(var l = new st([
            i,
            s
        ], t.dtype), c = this.readSync(e.dataId), h = this.readSync(t.dataId), p = 0; p < i; p++){
        ...
        var r = kr(0, t, n), o = r.sliceRank, a = r.numUpdates, i = r.sliceSize, s = r.strides, u = r.outputSize, l = vn(0);
        ...
        var c = [
            r / o,
            o
        ], h = this.readSync(t.dataId), p = this.readSync(e.dataId);
...
function _c(t, e) {
    for(var n = {}, r = 0, o = function(e) {
        var o = e.name, a = e.dtype, i = e.shape, u = y(i), l = void 0;
        if ("quantization" in e) {
            ...
            var h = Tc[c.dtype], p = t.slice(r, r + u * h), f = "uint8" === c.dtype ? new Uint8Array(p) : new Uint16Array(p);
            ...
            var d = e, v = new Uint8Array(t.slice(r, r + d.byteLength));
            l = s.platform.decodeUTF8(v).split(d.delimiter), r += d.byteLength;
        } else {
            var m = Tc[a];
            p = t.slice(r, r + u * m);
            if ("float32" === a) l = new Float32Array(p);
            else if ("int32" === a) l = new Int32Array(p);
            else {
...
var Fc = "undefined" != typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"] && ("undefined" == typeof Blob || "undefined" == typeof atob || "undefined" == typeof btoa);
function Mc(t) {
    return Fc ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].byteLength(t) : new Blob([
        t
    ]).size;
}
function Bc(t) {
        ...
        return o(this, function(o) {
            switch(o.label){
                case 0:
                    ...
                    }), s = i[0], u = Vc(t).scheme, l = Vc(t).path, c = u === Vc(t).scheme, [
                        4,
                        a.load()
                    ];
                case 1:
    ...
    return t.prototype.save = function(t) {
        ...
        return new Promise(function(t, r) {
            ...
            o.onupgradeneeded = function() {
                ...
                var a = o.result;
                if (null == e) {
                    var i = a.transaction(qc, "readonly"), s = i.objectStore(qc).get(n.modelPath);
                    ...
                    var u, l = Lc(e), c = a.transaction(Hc, "readwrite"), h = c.objectStore(Hc), p = h.put({
...
var Yc = function() {
    ...
    return t.prototype.listModels = function() {
                ...
                return [
                    ...
                    new Promise(function(e, n) {
                        ...
                        r.onupgradeneeded = function() {
                            ...
                            var t = r.result, o = t.transaction(Hc, "readonly"), a = o.objectStore(Hc).getAll();
        ...
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(n) {
                var r;
                return t = (r = t).startsWith(Kc.URL_SCHEME) ? r.slice(Kc.URL_SCHEME.length) : r, [
                    2,
                    new Promise(function(n, r) {
                        ...
                        o.onupgradeneeded = function() {
                            ...
                            var e, a = o.result, i = a.transaction(Hc, "readwrite"), s = i.objectStore(Hc), u = s.get(t);
...
var Qc = "/", Jc = "tensorflowjs_models", Zc = "info", th = "model_topology", eh = "weight_specs", nh = "weight_data", rh = "model_metadata";
function oh(t) {
    return {
        info: [
            Jc,
    ...
    return t.prototype.save = function(t) {
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(o) {
                ...
                try {
                    return this.LS.setItem(this.keys.info, JSON.stringify(r)), this.LS.setItem(this.keys.topology, e), this.LS.setItem(this.keys.weightSpecs, n), this.LS.setItem(this.keys.weightData, (a = t.weightData, Fc ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Buffer"].from(a).toString("base64") : btoa(String.fromCharCode.apply(null, new Uint8Array(a))))), this.LS.setItem(this.keys.modelMetadata, JSON.stringify({
                        format: t.format,
...
var lh = "model", ch = ".json", hh = ".weights.bin";
function ph(t) {
        ...
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(o) {
                switch(o.label){
                    ...
                    case 2:
                        return o.sent(), null == t.weightData ? [
                            3,
                            4
                    ...
                    case 0:
                        if (e = n.map(function() {
                            ...
                            t.weights.forEach(function(t) {
                                var a = "quantization" in t ? t.quantization.dtype : t.dtype, l = Tc[a] * y(t.shape), c = function() {
                    ...
                    case 1:
                        return p = o.sent(), f = {}, d = 0, c.forEach(function(t) {
                            ...
                            r[t].forEach(function(t) {
                                var e = _c(i.slice(t.groupOffset, t.groupOffset + t.sizeBytes), [
                                    t.manifestEntry
                                ]);
                ...
                switch(h.label){
                    case 0:
                        for(n = [], a = [], i = Array.isArray(t) ? t.map(function(t) {
                            ...
                            var l = i[u], h = Array.isArray(t) ? t[u].tensor : t[l];
                                    ...
                                    return r(c, void 0, void 0, function() {
                                        ...
                                        return o(this, function(o) {
                                            switch(o.label){
                                                ...
                                                case 1:
                                                    return n = o.sent(), r = s.platform.encodeUTF8(n.join(Dc)), e.byteLength = r.length, e.delimiter = Dc, t(r), [
                                                        2
                                                    ];
                                            }
                                        });
    ...
    removeModel: function(t) {
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(n) {
                return e = Vc(t), [
                    2,
                    zc.getManager(e.scheme).removeModel(e.path)
                ];
            });
        });
    }
...
var Ih = ln({
    confusionMatrix_: function(t, e, n) {
        var r = Ye(t, "labels", "confusionMatrix"), o = Ye(e, "predictions", "confusionMatrix");
        ...
        var a = nr(r.asType("int32"), n), i = nr(o.asType("int32"), n);
        ...
        return r(this, void 0, void 0, function() {
            ...
            return o(this, function(o) {
                switch(o.label){
                    ...
                    case 1:
                        return u = o.sent(), l = n.min(), c = n.max(), [
                            4,
                            Promise.all([
                                l.data(),
                                c.data()
...
var qh = function(t) {
    ...
    return e(n, t), n.prototype.applyGradients = function(t) {
        ...
        Fe(function() {
            var r = vl(1, e.accBeta1), o = vl(1, e.accBeta2);
            n.forEach(function(n, a) {
                ...
                if (null != s) {
                    var u = e.accumulatedFirstMoment[a].variable, l = e.accumulatedSecondMoment[a].variable, c = u.mul(e.beta1).add(s.mul(1 - e.beta1)), h = l.mul(e.beta2).add(s.square().mul(1 - e.beta2)), p = c.div(r), f = h.div(o);
...
var Hh = function(t) {
    ...
    return e(n, t), n.prototype.applyGradients = function(t) {
        ...
        Fe(function() {
            var r = vl(1, e.accBeta1), o = tl(-e.learningRate, e.iteration.mul(e.decay).add(1));
            n.forEach(function(n, a) {
                var i = At.registeredVariables[n];
                null == e.accumulatedFirstMoment[a] && (e.accumulatedFirstMoment[a] = {
                    originalName: n + "/m",
                ...
                var s = Array.isArray(t) ? t[a].tensor : t[n];
                if (null != s) {
                    var u = e.accumulatedFirstMoment[a].variable, l = e.accumulatedWeightedInfNorm[a].variable, c = u.mul(e.beta1).add(s.mul(1 - e.beta1)), h = l.mul(e.beta2), p = s.abs(), f = h.maximum(p);
        ...
        (Array.isArray(t) ? t.map(function(t) {
            ...
            if (null != a) {
                ...
                Fe(function() {
                    ...
                    if (e.centered) {
                        var n = e.accumulatedMeanGrads[r].variable, u = n.mul(e.decay).add(a.mul(1 - e.decay)), l = s.mul(e.momentum).add(a.mul(e.learningRate).div(t.sub(u.square().add(e.epsilon)).sqrt()));
