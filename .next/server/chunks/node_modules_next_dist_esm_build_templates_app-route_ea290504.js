...
Pregunta del usuario: ${t}`,l=await i.generateContent(r),c=(await l.response).text();if(!c)throw Error("No se recibió respuesta del modelo");return k.NextResponse.json({response:c})}catch(t){let e=t instanceof Error?t.message:String(t);return k.NextResponse.json({response:`Error del asistente: ${e}`},{status:500})}}e.s(["POST",()=>eT],86969);var ev=e.i(86969);let eA=new v.AppRouteRouteModule({definition:{kind:A.RouteKind.APP_ROUTE,page:"/api/ask/route",pathname:"/api/ask",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/ask/route.ts",nextConfigOutput:"",userland:ev}),{workAsyncStorage:eN,workUnitAsyncStorage:ew,serverHooks:eS}=eA;function eb(){return(0,N.patchFetch)({workAsyncStorage:eN,workUnitAsyncStorage:ew})}async function ex(e,t,n){eA.isDev&&(0,w.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let s="/api/ask/route";s=s.replace(/\/index$/,"")||"/";let o=await eA.prepare(e,t,{srcPage:s,multiZoneDraftMode:!1});if(!o)return t.statusCode=400,t.end("Bad Request"),null==n.waitUntil||n.waitUntil.call(n,Promise.resolve()),null;let{buildId:a,params:i,nextConfig:r,parsedUrl:l,isDraftMode:c,prerenderManifest:d,routerServerContext:u,isOnDemandRevalidate:h,revalidateOnlyGenerated:f,resolvedPathname:p,clientReferenceManifest:g,serverActionsManifest:E}=o,m=(0,x.normalizeAppPath)(s),C=!!(d.dynamicRoutes[m]||d.routes[p]),O=async()=>((null==u?void 0:u.render404)?await u.render404(e,t,l,!1):t.end("This page could not be found"),null);if(C&&!c){let e=!!d.routes[p],t=d.dynamicRoutes[m];if(t&&!1===t.fallback&&!e){if(r.experimental.adapterPath)return await O();throw new G.NoFallbackError}}let R=null;!C||eA.isDev||c||(R="/index"===(R=p)?"/":R);let y=!0===eA.isDev||!C,_=C&&!y;E&&g&&(0,b.setManifestsSingleton)({page:s,clientReferenceManifest:g,serverActionsManifest:E});let I=e.method||"GET",T=(0,S.getTracer)(),v=T.getActiveScopeSpan(),N={params:i,prerenderManifest:d,renderOpts:{experimental:{authInterrupts:!!r.experimental.authInterrupts},cacheComponents:!!r.cacheComponents,supportsDynamicResponse:y,incrementalCache:(0,w.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:r.cacheLife,waitUntil:n.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,n,s,o)=>eA.onRequestError(e,t,s,o,u)},sharedContext:{buildId:a}},k=new M.NodeNextRequest(e),K=new M.NodeNextResponse(t),q=P.NextRequestAdapter.fromNodeNextRequest(k,(0,P.signalFromNodeResponse)(t));try{let o=async e=>eA.handle(q,N).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let n=T.getRootSpanAttributes();if(!n)return;if(n.get("next.span_type")!==D.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${n.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let o=n.get("next.route");if(o){let t=`${I} ${o}`;e.setAttributes({"next.route":o,"http.route":o,"next.span_name":t}),e.updateName(t)}else e.updateName(`${I} ${s}`)}),a=!!(0,w.getRequestMeta)(e,"minimalMode"),i=async i=>{var l,p;let g=async({previousCacheEntry:r})=>{try{if(!a&&h&&f&&!r)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let s=await o(i);e.fetchMetrics=N.renderOpts.fetchMetrics;let l=N.renderOpts.pendingWaitUntil;l&&n.waitUntil&&(n.waitUntil(l),l=void 0);let c=N.renderOpts.collectedTags;if(!C)return await (0,L.sendResponse)(k,K,s,N.renderOpts.pendingWaitUntil),null;{let e=await s.blob(),t=(0,U.toNodeOutgoingHttpHeaders)(s.headers);c&&(t[F.NEXT_CACHE_TAGS_HEADER]=c),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let n=void 0!==N.renderOpts.collectedRevalidate&&!(N.renderOpts.collectedRevalidate>=F.INFINITE_CACHE)&&N.renderOpts.collectedRevalidate,o=void 0===N.renderOpts.collectedExpire||N.renderOpts.collectedExpire>=F.INFINITE_CACHE?void 0:N.renderOpts.collectedExpire;return{value:{kind:$.CachedRouteKind.APP_ROUTE,status:s.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:n,expire:o}}}}catch(t){throw(null==r?void 0:r.isStale)&&await eA.onRequestError(e,t,{routerKind:"App Router",routePath:s,routeType:"route",revalidateReason:(0,H.getRevalidateReason)({isStaticGeneration:_,isOnDemandRevalidate:h})},!1,u),t}},E=await eA.handleResponse({req:e,nextConfig:r,cacheKey:R,routeKind:A.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:d,isRoutePPREnabled:!1,isOnDemandRevalidate:h,revalidateOnlyGenerated:f,responseGenerator:g,waitUntil:n.waitUntil,isMinimalMode:a});if(!C)return null;if((null==E||null==(l=E.value)?void 0:l.kind)!==$.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==E||null==(p=E.value)?void 0:p.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});a||t.setHeader("x-nextjs-cache",h?"REVALIDATED":E.isMiss?"MISS":E.isStale?"STALE":"HIT"),c&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,U.fromNodeOutgoingHttpHeaders)(E.value.headers);return a&&C||m.delete(F.NEXT_CACHE_TAGS_HEADER),!E.cacheControl||t.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,j.getCacheControlHeader)(E.cacheControl)),await (0,L.sendResponse)(k,K,new Response(E.value.body,{headers:m,status:E.value.status||200})),null};v?await i(v):await T.withPropagatedContext(e.headers,()=>T.trace(D.BaseServerSpan.handleRequest,{spanName:`${I} ${s}`,kind:S.SpanKind.SERVER,attributes:{"http.method":I,"http.target":e.url}},i))}catch(t){if(t instanceof G.NoFallbackError||await eA.onRequestError(e,t,{routerKind:"App Router",routePath:m,routeType:"route",revalidateReason:(0,H.getRevalidateReason)({isStaticGeneration:_,isOnDemandRevalidate:h})},!1,u),C)throw t;return await (0,L.sendResponse)(k,K,new Response(null,{status:500})),null}}e.s(["handler",()=>ex,"patchFetch",()=>eb,"routeModule",()=>eA,"serverHooks",()=>eS,"workAsyncStorage",()=>eN,"workUnitAsyncStorage",()=>ew],71288)}];
